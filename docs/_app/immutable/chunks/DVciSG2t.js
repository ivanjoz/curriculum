var e=e=>`data:image/svg+xml;charset=utf-8,${encodeURIComponent(e)}`,t=(e,t)=>{let n=new Map,r=0;for(;r<=0;){let t=e.indexOf(`fill="`,r);if(t===-1)break;let i=e.indexOf(`"`,t+6),a=e.substring(t+6,i);n.set(`c-${a}`,[t,a,`fill="$"`]),r=i+1}for(;r<=0;){let t=e.indexOf(`fill:`,r);if(t===-1)break;let i=e.indexOf(`;`,t+5),a=e.substring(t+5,i);n.set(`s-${a}`,[t,a,`fill:$`]),r=i+1}let i=Array.from(n.values()).sort((e,t)=>e[0]-t[0]);for(let n=0;n<i.length;n++){let r=t[n];if(!r)break;let[a,o,s]=i[n];e=e.replaceAll(s.replace(`$`,o),s.replace(`$`,r))}return e},n={1:{es:`Ene`,en:`Jan`},2:{es:`Feb`,en:`Feb`},3:{es:`Mar`,en:`Mar`},4:{es:`Abr`,en:`Apr`},5:{es:`May`,en:`May`},6:{es:`Jun`,en:`Jun`},7:{es:`Jul`,en:`Jul`},8:{es:`Ago`,en:`Ago`},9:{es:`Sep`,en:`Sep`},10:{es:`Oct`,en:`Oct`},11:{es:`Nov`,en:`Nov`},12:{es:`Dic`,en:`Dec`}},r=e=>{if(e===-1)return`Present`;let t=String(e).substring(0,4),r=n[String(parseInt(String(e).substring(4,6)))];return`${i(r||``)} ${t}`},i=e=>typeof e==`string`?e:e.es||e.en,a=e=>{let t=[322.52,316.32,310.11,303.91,300.19];e||=1;for(let n=0;n<t.length;n++)t[n]=Math.floor(t[n]*e);return`
...
`,x=`<svg xmlns="http://www.w3.org/2000/svg" class="prefix__aa prefix__bb" viewBox="0 0 1261.8 1261.8"><circle cx="630.9" cy="630.9" r="630.9"/><g data-name="Layer 2"><path fill="#f9f9f9" d="M688.1 652.4a295.3 295.3 0 0 1-294.4 296.3A295.4 295.4 0 0 1 99.4 652.4 295.4 295.4 0 0 1 393.7 356a295.3 295.3 0 0 1 294.4 296.4m322.9 0c0 154-66 279-147.2 279-81.3 0-147.2-125-147.2-279s65.9-279 147.2-279 147.2 124.9 147.2 279m132 0c0 138-23.1 249.9-51.7 249.9s-51.8-112-51.8-250 23.2-249.8 51.9-249.8 51.7 112 51.7 250" data-name="Layer 1"/></g></svg>
`,S={tecnologias:{es:`Tecnologías / Años de Experiencia`},descripcion:{es:`5+ años de experiencia desarrollando sistemas cloud con Node.Js, Go y C# y AWS, Linux, frontend con React y bases de datos SQL.`},sub1:{es:`Experiencia adicional en:`},sub2:{es:`Día de trabajo habitual:`},sub3:{es:`Skills:`},sub4:{es:`Experiencia Laboral:`},sub5:{es:`Últimos Proyectos:`},sub6:{es:`F.O.D.A`},sub7:{es:`Estudios`}},C=[{percent:72,content:{es:`Desarrollo (código)`,en:`Desarrollo (código)`}},{percent:16,content:{es:`Levantamiento de definiciones funcionales, investigación, documentación y arquitectura`,en:`Levantamiento de definiciones funcionales, investigación, documentación y arquitectura`}},{percent:12,content:{es:`Reuniones de coordinación, daylis y mentoría`,en:`Reuniones de coordinación, daylis y mentoría`}}],w=[{icon:b,url:`https://github.com/ivanjoz/`,name:`Github`,user:`/ivanjoz`},{icon:y,url:`https://www.linkedin.com/in/anguloivan/`,name:`LinkedIn`,user:`/anguloivan`},{icon:x,url:`https://medium.com/@angivan`,name:`Medium`,user:`@angivan`}],T=[{desc:`Experiencia como Scrum Master en proyectos Agile`,icon:m,order1:2},{desc:`Inglés avanzado y español nativo`,icon:h,order1:1},{desc:`Experiencia en arquitectura cloud, AWS y DevOps`,icon:f,order1:3,marginTop:-10},{desc:`Habilidades comunicativas y de coordinación`,icon:d,order1:5,marginTop:-16},{desc:`Desarrollo enfocado en escalabilidad y mantenibilidad en sistemas complejos`,icon:p,order1:4}],E=[{es:`Git, Python, Kotlin y Flutter + Dart`,en:``},{es:`AWS: Cloudformation, IAM, API-Gateway, CloudFront`,en:``},{es:`Web APIs, Service Workers, PWA, WebSockets, Vite.js, Next.js`,en:``},{es:`Cálculos geo-espaciales y renderización de mapas`,en:``}],D=[{name:`Go Programming`,years:[[22,6],[23,8],[24,8]]},{name:`C# & .NET Core`,years:[[20,6],[21,4],[22,3]]},{name:`Solid.js`,years:[[22,3],[23,4],[23,6]]},{name:`ScyllaDB / Cassandra`,years:[[23,3],[24,4]]},{name:`Node.js`,years:[[19,8],[20,8],[21,6],[22,5],[23,4]]},{name:`React.js`,years:[[19,3],[20,5],[21,6],[22,8],[23,6],[23,4]]},{name:`Angular`,years:[[20,8],[21,4]]},{name:`PostgreSQL`,years:[[20,4],[21,5],[22,8],[23,7]]},{name:`SQL Server`,years:[[17,4],[20,8],[21,4]]},{name:`Mongo DB, ArangoDB`,years:[[18,7],[19,7]]},{name:`JavaScript / TypeScript`,years:[[17,8],[18,7],[19,7],[20,7],[21,6],[22,6],[23,6],[24,6]]},{name:`Linux, Bash, Nginx, VPS`,years:[[16,3],[17,3],[18,2],[19,1],[20,3],[21,2],[22,2],[23,2],[24,2]]},{name:`PHP, Wordpress`,years:[[16,5],[17,4],[18,4]]},{name:`AWS Lambda, EC2, S3...`,years:[[20,4],[21,4],[22,5],[23,6],[24,6]]},{name:`Docker / Podman`,years:[[22,3],[23,6],[24,5]]},{name:`Rust`,years:[[21,2],[23,4],[24,5]]},{name:`Google Cloud / Firebase`,years:[[21,3],[22,4]]},{name:`DynamoDB`,years:[[21,2],[22,2],[22,3],[24,4]]},{name:`Infra & CI/CD Tools`,years:[[22,3],[23,3],[24,3]]},{name:`AWS Athena, Glue, ETLs`,years:[[22,2],[23,3],[24,2]]}],O=[{company:`Hortifrut SA`,years:[202211,-1],description:[`Desarrollo de software empresarial para áreas de producción, sanidad y mejora contínua con React.js, Go, Node.js, PostgreSQL y DynamoDB`,`Desarrollo sobre servicios AWS como Lambda, S3, ECS, CloudFront, Athena, API-Gateway mediante SDK y CLI`,`Coordinación con múltiples áreas para el levantamiento técnico-funcional de los proyectos de software`],role:`Full Stack Developer`,logo:o,pdfCardHeight:1.1},{company:`Yawi Solutions`,role:`Senior Software Developer`,years:[202003,202211],logo:s,pdfCardHeight:1.1,description:[`Desarrollo de software empresarial con Angular, React.js + Vite.js, C# / .NET Core, Node.js y Go.`,`Modelado de base de datos Sql-Server y PostgreSQL`,`Manejo de librerías gráficas (web), estadísticas y geo-espaciales`,`Diseño de arquitectura cloud en AWS con CloudFormation y en Azure.`,`Lider técnico del equipo de Software Factory y rol como Scrum Master`]},{company:`Upwork`,years:[201906,202003],logo:c,pdfCardHeight:.9,description:[`Desarrollo de sistemas web con React, Node y MongoDB: Catálogo de cursos para institución educativa`,`Desarrollo de gestor de contenidos para páginas web con JavaScript`,`Desarrollo de sistema de búsqueda de empleo y scraping con React, Node.js y PostgreSQL`],role:`Freelance Software Developer`},{company:`Unicore`,logo:l,years:[201804,201906],role:`Software Developer & Founder`,pdfCardHeight:.95,description:[`Desarrollo de sistema empresarial con módulos de ventas, finanzas, logística, productos y facturación electrónica usando PostgreSQL, DynamoDB, Node.js, React.js y WebSockets`,`Desarrollo de páginas webs con CMS e integración con plataformas de pago.`,`Uso de AWS Lambda, S3, EC2 y Linux VPCs y Bash`]},{company:`Permex International`,logoImg:`images/permex4.webp`,years:[201604,201802],role:`Jefe de Operaciones`,pdfCardHeight:.9,description:[`Planificación y control de la producción y el abastecimiento para la producción de chips de carnaza`,`Gestión de la logística internacional y trámites para la exportación de contenedores a USA`,`Elaboración de presupuestos, reportes de gastos y gestión financiera.`]},{company:`EQUOM SAC`,years:[201501,201603],logo:u,pdfCardHeight:.8,description:[`Participación en desarrollo de CompuBox: Mini-PC Linux con procesador ARM`,`Coordinación con proveedores internacionales, gestión del proceso de importación y manejo financiero`],role:`Jefe de Operaciones`}],k=[{es:`Genix: Sistema de gestión para Mypes (Logística, Comercial, Finanzas)`},{es:`Librería de conversación de imagen .webp y .avif en Go con binarios precompilados hechos en Rust`},{es:`ORM para ScyllaDB / Cassandra hecho en Go`},{es:`SmartBerry. Sistema de gestión de producción agrícola de Hortifrut`},{es:`Jobfinder. Sistema de búsqueda de empleos y scraping`},{es:`Páginas web y CSM con React + Next.js`}],A=[{name:`FORTALEZAS`,list:[`Balance entre habilidades técnicas y blandas`,`Experiencia en varios lenguajes y frameworks permite adoptar nuevas herramientas rápido`,`Experiencia en arquitectura cloud / AWS`,`Background en negocios, finanzas y operaciones en empresas industriales`,`Experiencia desarrollando sobre bases de código grandes con equipos multidisciplinarios`]},{name:`DEBILIDADES`,list:[`Poca experiencia en kubernetes, MS-Windows y apps móviles`,`Poca experiencia en Python, AI y ciencia de datos`,`Tendencia de asumir el riesgo de incorporar nuevas tecnologías`]},{name:`OPORTUNIDADES`,list:[`Tecnologías actuales`]},{name:`AMENAZAS`,list:[`TBD`]}],j=[{name:`Platzi`,carrer:`Desarrollo de Software`,logo:g,years:`2019-2022`,content:[`Cursos: JavaScript, TypeScript, ReactJS, Golang, Frontend Development,
    Back-end con NodeJs y ExpressJs. SCRUM. Arquitectura cloud con AWS.`]},{name:`Uni. Privada Antenor Orrego`,carrer:`Maestría en Administración con Mención en Finanzas`,logo:_,years:`2018-2019`,content:[]},{name:`Uni. Privada del Norte`,carrer:`Carrera de Administración y negocios internacionales`,logo:v,years:`2009-2014`,content:[`Licenciado`,`Rendimiento: 5to Superior`,`Tesis: Reducción del precio CIF mediante el apalancamiento operativo-financiero.`]}],M=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 20"><path d="m24.85 18 1.5 1.66A3 3 0 0 1 25 20H3a3 3 0 0 1-1.35-.34L3.14 18l6.47-7.19L12 13.17a2.8 2.8 0 0 0 4 0l2.41-2.36zm-11.43-6.26a.8.8 0 0 0 1.16 0L24.53 2 26.27.29A3 3 0 0 0 25 0H3a3 3 0 0 0-1.27.29L3.47 2ZM8.18 9.41 2 3.36.31 1.7A3 3 0 0 0 0 3v14a3 3 0 0 0 .26 1.21L2 16.28ZM27.69 1.7 26 3.36l-6.18 6.05L26 16.28l1.74 1.93A3 3 0 0 0 28 17V3a3 3 0 0 0-.31-1.3" fill="#ffcc6f" data-name="Layer 2"/></svg>
`,N=`<svg xml:space="preserve" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 41.4 64.2"><path d="M39.3 29.7c1.3-2.7 2.1-5.8 2.1-9C41.4 9.3 32.1 0 20.7 0S0 9.3 0 20.7c0 3.2.8 6.3 2.1 9 0 0 .4.9.5 1l18.1 33.5 17.9-33c.2-.4.7-1.5.7-1.5M20.7 10.4C26.4 10.4 31 15 31 20.7s-4.6 10.4-10.3 10.4-10.3-4.6-10.3-10.3S15 10.4 20.7 10.4" fill="#fea"/></svg>
`;export{t as _,A as a,w as c,k as d,O as f,r as g,e as h,E as i,j as l,a as m,M as n,S as o,i as p,C as r,T as s,N as t,D as u};