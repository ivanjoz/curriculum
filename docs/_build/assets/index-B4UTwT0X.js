import{q as a,h as q,d as u,t as k,B as t,C as L}from"./web-ClD8jM4J.js";const Q=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
...
`,n0=`<?xml version="1.0" encoding="UTF-8"?>
...
`,e0=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
   version="1.1"
   x="0px"
   y="0px"
...
`,o0=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
   width="362.61874"
   height="373.60001"
...
`,p0=[{percent:72,content:{es:"Desarrollo (código)",en:"Desarrollo (código)"}},{percent:16,content:{es:"Levantamiento de definiciones funcionales, investigación, documentación y arquitectura",en:"Levantamiento de definiciones funcionales, investigación, documentación y arquitectura"}},{percent:12,content:{es:"Reuniones de coordinación, daylis y mentoría",en:"Reuniones de coordinación, daylis y mentoría"}}],m0=[{icon:r0},{icon:l0},{icon:d0}],h0=[{desc:"Experiencia como Scrum Master en proyectos Agile",icon:a0},{desc:"Inglés avanzado y español nativo",icon:i0},{desc:"Experiencia en arquitectura cloud, AWS y DevOps",icon:e0},{desc:"Habilidades comunicativas y de coordinación",icon:n0},{desc:"Desarrollo enfocado en escabilidad y mantenibilidad en sistemas complejos",icon:t0}],g0=[{es:"Git, Python, Kotlin y Flutter + Dart",en:""},{es:"AWS: Cloudformation, IAM, API-Gateway, CloudFront",en:""},{es:"Vite.js, Next.js, Service Workers, PWA, WebSockets",en:""},{es:"Cálculos geo-espaciales y renderización de mapas",en:""}],f0=[{name:"Go Programming",years:[[22,6],[23,8],[24,8]]},{name:"C# & .NET Core",years:[[20,6],[21,4],[22,3]]},{name:"Solid.js",years:[[22,3],[23,4],[23,6]]},{name:"ScyllaDB / Cassandra",years:[[23,3],[24,4]]},{name:"Node.js",years:[[19,8],[20,8],[21,6],[22,5],[23,4]]},{name:"React.js",years:[[19,3],[20,5],[21,6],[22,8],[23,6],[23,4]]},{name:"Angular",years:[[20,8],[21,4]]},{name:"PostgreSQL",years:[[20,4],[21,5],[22,8],[23,7]]},{name:"SQL Server",years:[[17,4],[20,8],[21,4]]},{name:"Mongo DB / ArangoDB",years:[[18,7],[19,7]]},{name:"JavaScript & WebAPIs",years:[[17,8],[18,7],[19,7],[20,7],[21,6],[22,6],[23,6],[24,6]]},{name:"Linux / Bash / Nginx / VPS",years:[[16,3],[17,3],[18,2],[19,1],[20,3],[21,2],[22,2],[23,2],[24,2]]},{name:"PHP / Wordpress",years:[[16,5],[17,4],[18,4]]},{name:"AWS Lambda, EC2, ECS, S3",years:[[20,4],[21,4],[22,5],[23,6],[24,6]]},{name:"Docker / Podman",years:[[22,3],[23,6],[24,5]]},{name:"Rust",years:[[21,2],[23,4],[24,5]]},{name:"Google Cloud / Firebase",years:[[21,3],[22,4]]},{name:"DynamoDB",years:[[21,2],[22,2],[22,3],[24,4]]},{name:"Infra & CI/CD Tools",years:[[22,3],[23,3],[24,3]]},{name:"AWS Athena / Glue / ETLs",years:[[22,2],[23,3],[24,2]]}],v0=[{company:"Hortifrut SA",description:["Desarrollo de software empresarial para áreas de producción, sanidad y mejora contínua con React.js, Go, Node.js, PostgreSQL y DynamoDB","Desarrollo sobre servicios AWS como Lambda, S3, ECS, CloudFront, Athena, API-Gateway mediante SDK y CLI","Coordinación con múltiples áreas para el levantamiento técnico-funcional de los proyectos de software"],role:"Full Stack Developer",logo:Q},{company:"Yawi Solutions",role:"Senior Software Developer",logo:J,description:["Desarrollo de software empresarial con Angular, React.js + Vite.js, C# / .NET Core, Node.js y Go.","Modelado de base de datos Sql-Server y PostgreSQL","Manejo de librerías gráficas (web), estadísticas y geo-espaciales","Diseño de arquitectura cloud en AWS con CloudFormation y en Azure.","Lider técnico del equipo de Software Factory y rol como Scrum Master"]},{company:"Upwork",logo:K,description:["Desarrollo de sistemas web con React, Node y MongoDB: Catálogo de cursos para institución educativa","Desarrollo de gestor de contenidos para páginas web con JavaScript","Desarrollo de sistema de búsqueda de empleo y scraping con React, Node.js y PostgreSQL"],role:"Freelance Software Developer"},{company:"Unicore",logo:Y,role:"Software Developer & Founder",description:["Desarrollo de sistema empresarial con módulos de ventas, finanzas, logística, productos y facturación electrónica usando PostgreSQL, DynamoDB, Node.js, React.js y WebSockets","Desarrollo de páginas webs con CMS e integración con plataformas de pago.","Uso de AWS Lambda, S3, EC2 y Linux VPCs y Bash"]},{company:"Permex International",logoImg:"images/permex4.webp",role:"Jefe de Operaciones",description:["Planificación y control de la producción y el abastecimiento para la producción de chips de carnaza","Gestión de la logística internacional y trámites para la exportación de contenedores a USA","Elaboración de presupuestos, reportes de gastos y gestión financiera."]},{company:"EQUOM SAC",logo:X,description:["Participación en desarrollo de CompuBox: Mini-PC Linux con procesador ARM","Coordinación con proveedores internacionales, gestión del proceso de importación y manejo financiero"],role:"Jefe de Operaciones"}],w0=[{name:"FORTALEZAS",list:["Balance entre habilidades técnicas y blandas","Experiencia en varios lenguajes y framework permite adoptar nuevas herramientas rápido","Experiencia en arquitectura cloud / AWS","Background en negocios, finanzas y operaciones en empresas industriales","Experiencia desarrollando sobre bases de código grandes con equipos multidiciplinarios"]},{name:"DEBILIDADES",list:["Poca experiencia en kubernetes, MS-Windows y apps móviles","Poca experiencia en Python, AI y ciencia de datos","Tendencia de asumir el riesgo de incorporar nuevas tecnologías"]},{name:"OPORTUNIDADES",list:["Tecnologías actuales"]},{name:"AMENAZAS",list:["TBD"]}],y0=[{name:"Platzi",logo:s0,content:[]},{name:"Uni. Privada Antenor Orrego",logo:c0,content:[]},{name:"Uni. Privada del Norte",logo:o0,content:[]}],k0="_",x0="a",u0="b",_0="c",z0="d",b0="e",S0="f",D0="g",C0="h",G0="i",V0="j",$0="k",A0="l",I0="m",U0="n",P0="o",M0="p",L0="q",H0="r",T0="s",F0="t",q0="u",B0="v",O0="w",R0="x",E0="y",e={main:k0,content:x0,about_me_layer:u0,about_me_layer_inline:_0,photo_circle:z0,letter:b0,location:S0,location_container:D0,table_header:C0,table_cell:G0,cell_line:V0,table_main_container:$0,table_main:A0,table_cell_1:I0,table_card:U0,table_card_container:P0,table_card_image_ctn:M0,table_card_image:L0,foda_card:H0,skill_card:T0,skill_image:F0,skill_descrip:q0,skill_card_container:B0,social_icon:O0,about_me:R0,tecnologias_container:E0},j0=`<?xml version="1.0" encoding="UTF-8"?>
...
`,H=s=>`data:image/svg+xml;charset=utf-8,${encodeURIComponent(s)}`;var j=k("<div>"),W0=k("<div><div>"),Z0=k('<div><div><h2 class=bold>Tecnologías / Años de Experiencia</h2><div><div><table><thead><tr></tr></thead><tbody></tbody></table></div><div><div class="bold h3 tt-c1">Experiencia adicional en:</div><div></div><div class="bold h3 tt-c1">Día de trabajo habitual:</div><table><tbody></tbody></table></div></div><h2>Skills</h2><div></div><h2 class=bold>Experiencia Laboral</h2><div></div><h2 class=bold>Últimos Proyectos</h2><div><div>● Genix: Sistema de gestión para Mypes (Logística, Comercial, Finanzas)</div><div>● Librería de conversación de imagen .webp y .avif en Go con binarios precompilados hechos en Rust.</div><div>● ORM para ScyllaDB / Cassandra hecho en Go.</div><div>● SmartBerry. Sistema de gestión de producción agrícola de Hortifrut.</div><div>● Sistema de componentes frontend en Solid.Js</div><div>● Jobfinder. Sistema de búsqueda de empleos y scraping.</div><div>● Páginas web y CSM con React + Next.js</div></div><h2 class=bold>F.O.D.A</h2><div></div><h2 class=bold>Estudios</h2><div>'),N0=k("<th><div>"),Q0=k("<tr>"),J0=k("<td>"),K0=k("<div class=flex><div>●</div><div>"),Y0=k('<tr><td class="bold h3"></td><td class="">'),X0=k('<div><img alt=""><div>'),n1=k('<div><div class="bold h5 tt-c1 w100 ta-c">'),W=k("<div>● "),e1=k('<div><div><div><img src=images/ivan-angulo-profile.webp alt="ivan angulo reyna profile"></div><div><h1 class="h1 bold">Iván J. Angulo Reyna</h1></div><div><img alt=""><div>Trujillo - Perú</div></div><div>ivan@un.pe</div></div><div><div><h2 class="h2 bold">Software Developer FullStack</h2></div><div>5+ años de experiencia desarrollando sistemas cloud con Node.Js, Go y C# y AWS, Linux, frontend con React y bases de datos SQL.</div><div class=flex>'),t1=k('<div><img alt="">'),Z=k('<div><div><div><img alt=""></div><div><div class="h2 bold tt-c1"></div><div></div></div></div><div>');const a1=17,i1=24,B=s=>typeof s=="string"?s:s.es||s.en;function l1(){const s=[{name:"",setContent:c=>(()=>{var d=j();return a(d,()=>c.name),u(()=>t(d,e.table_cell_1)),d})()}];for(let c=a1;c<=i1;c++)s.push({name:`${c}`,headerCss:e.table_header,cellCss:e.table_cell,setContent:d=>{const w=d.years.find(h=>h[0]===c);if(!w)return null;let p=0;return p=(w[1]-1)*2,p<3&&(p=3),p>18&&(p=18),(()=>{var h=W0(),g=h.firstChild;return h.style.setProperty("height","100%"),h.style.setProperty("position","relative"),`${p}px`!=null?g.style.setProperty("height",`${p}px`):g.style.removeProperty("height"),u(()=>t(g,e.cell_line)),h})()}});return(()=>{var c=Z0(),d=c.firstChild,w=d.firstChild,p=w.nextSibling,h=p.firstChild,g=h.firstChild,S=g.firstChild,C=S.firstChild,i=S.nextSibling,o=h.nextSibling,_=o.firstChild,f=_.nextSibling,z=f.nextSibling,l=z.nextSibling,D=l.firstChild,V=p.nextSibling,x=V.nextSibling,G=x.nextSibling,b=G.nextSibling,T=b.nextSibling,A=T.nextSibling,F=A.nextSibling,$=F.nextSibling,N=$.nextSibling,O=N.nextSibling;return a(c,q(E,{get css(){return e.about_me_layer}}),d),a(c,q(E,{get css(){return e.about_me_layer_inline}}),d),a(C,()=>s.map(n=>(()=>{var r=N0(),m=r.firstChild;return a(m,()=>n.name),u(()=>t(m,n.headerCss)),r})())),a(i,()=>f0.map(n=>(()=>{var r=Q0();return a(r,()=>s.map(m=>(()=>{var y=J0();return a(y,()=>m.setContent(n)),u(()=>t(y,m.cellCss)),y})())),r})())),o.style.setProperty("flex-grow","1"),o.style.setProperty("margin-left","1vw"),o.style.setProperty("display","flex"),o.style.setProperty("flex-direction","column"),a(o,()=>g0.map(n=>(()=>{var r=K0(),m=r.firstChild,y=m.nextSibling;return m.style.setProperty("width","0.8rem"),a(y,()=>B(n)),r})()),f),f.style.setProperty("width","100%"),f.style.setProperty("border-bottom","1px solid black"),f.style.setProperty("margin","12px 0"),a(D,()=>p0.map(n=>(()=>{var r=Y0(),m=r.firstChild,y=m.nextSibling;return a(m,()=>`${n.percent}%`),a(y,()=>B(n.content)),r})())),a(x,()=>h0.map(n=>(()=>{var r=X0(),m=r.firstChild,y=m.nextSibling;return a(y,()=>B(n.desc)),u(v=>{var I=`${e.skill_card}`,U=`${e.skill_image}`,P=H(n.icon),M=`${e.skill_descrip}`;return I!==v.e&&t(r,v.e=I),U!==v.t&&t(m,v.t=U),P!==v.a&&L(m,"src",v.a=P),M!==v.o&&t(y,v.o=M),v},{e:void 0,t:void 0,a:void 0,o:void 0}),r})())),a(b,()=>v0.map(n=>q(s1,{args:n}))),A.style.setProperty("padding-left","0.8rem"),a($,()=>w0.map(n=>(()=>{var r=n1(),m=r.firstChild;return a(m,()=>n.name),a(r,()=>n.list.map(y=>(()=>{var v=W();return v.firstChild,a(v,y,null),v})()),null),u(()=>t(r,e.foda_card)),r})())),a(O,()=>y0.map(n=>q(c1,{args:n}))),u(n=>{var r=e.main,m=e.content,y=`flex w100 ${e.tecnologias_container}`,v=e.table_main_container,I=`w100 ${e.table_main}`,U=`flex ${e.skill_card_container}`,P=e.table_card_container,M=e.table_card_container,R=e.table_card_container;return r!==n.e&&t(c,n.e=r),m!==n.t&&t(d,n.t=m),y!==n.a&&t(p,n.a=y),v!==n.o&&t(h,n.o=v),I!==n.i&&t(g,n.i=I),U!==n.n&&t(x,n.n=U),P!==n.s&&t(b,n.s=P),M!==n.h&&t($,n.h=M),R!==n.r&&t(O,n.r=R),n},{e:void 0,t:void 0,a:void 0,o:void 0,i:void 0,n:void 0,s:void 0,h:void 0,r:void 0}),c})()}const E=s=>(()=>{var c=e1(),d=c.firstChild,w=d.firstChild,p=w.nextSibling,h=p.nextSibling,g=h.firstChild,S=g.nextSibling,C=h.nextSibling,i=d.nextSibling,o=i.firstChild,_=o.firstChild,f=o.nextSibling,z=f.nextSibling;return g.style.setProperty("margin-right","3px"),g.style.setProperty("width","1rem"),g.style.setProperty("height","1rem"),_.style.setProperty("margin-bottom","0"),f.style.setProperty("padding","8px"),f.style.setProperty("text-align","center"),a(z,()=>m0.map(l=>(()=>{var D=t1(),V=D.firstChild;return u(x=>{var G=e.social_icon,b=H(l.icon);return G!==x.e&&t(D,x.e=G),b!==x.t&&L(V,"src",x.t=b),x},{e:void 0,t:void 0}),D})())),u(l=>{var D=s.css,V=e.photo_circle,x=`${e.letter}`,G=`flex ${e.location_container}`,b=H(j0),T=`h3 ${e.location}`,A=`h3 ${e.location}`,F=e.letter,$=`${e.letter} ${e.about_me}`;return D!==l.e&&t(c,l.e=D),V!==l.t&&t(w,l.t=V),x!==l.a&&t(p,l.a=x),G!==l.o&&t(h,l.o=G),b!==l.i&&L(g,"src",l.i=b),T!==l.n&&t(S,l.n=T),A!==l.s&&t(C,l.s=A),F!==l.h&&t(o,l.h=F),$!==l.r&&t(f,l.r=$),l},{e:void 0,t:void 0,a:void 0,o:void 0,i:void 0,n:void 0,s:void 0,h:void 0,r:void 0}),c})(),s1=s=>(console.log("logo:: ",s.args.logo),(()=>{var c=Z(),d=c.firstChild,w=d.firstChild,p=w.firstChild,h=w.nextSibling,g=h.firstChild,S=g.nextSibling,C=d.nextSibling;return d.style.setProperty("display","flex"),a(g,()=>s.args.company),a(S,()=>s.args.role),a(C,()=>s.args.description.map(i=>(()=>{var o=W();return o.firstChild,a(o,i,null),o})())),u(i=>{var o=e.table_card,_=e.table_card_image_ctn,f=e.table_card_image,z=s.args.logoImg||H(s.args.logo);return o!==i.e&&t(c,i.e=o),_!==i.t&&t(w,i.t=_),f!==i.a&&t(p,i.a=f),z!==i.o&&L(p,"src",i.o=z),i},{e:void 0,t:void 0,a:void 0,o:void 0}),c})()),c1=s=>(console.log("logo:: ",s.args.logo),(()=>{var c=Z(),d=c.firstChild,w=d.firstChild,p=w.firstChild,h=w.nextSibling,g=h.firstChild,S=g.nextSibling,C=d.nextSibling;return d.style.setProperty("display","flex"),a(g,()=>s.args.name),a(S,()=>s.args.content),a(C,()=>s.args.content.map(i=>(()=>{var o=j();return a(o,i),o})())),u(i=>{var o=e.table_card,_=e.table_card_image_ctn,f=e.table_card_image,z=H(s.args.logo);return o!==i.e&&t(c,i.e=o),_!==i.t&&t(w,i.t=_),f!==i.a&&t(p,i.a=f),z!==i.o&&L(p,"src",i.o=z),i},{e:void 0,t:void 0,a:void 0,o:void 0}),c})());export{l1 as default};
