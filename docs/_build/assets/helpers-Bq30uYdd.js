const d=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
...
`,C={tecnologias:{es:"Tecnologías / Años de Experiencia"},descripcion:{es:"5+ años de experiencia desarrollando sistemas cloud con Node.Js, Go y C# y AWS, Linux, frontend con React y bases de datos SQL."},sub1:{es:"Experiencia adicional en:"},sub2:{es:"Día de trabajo habitual:"},sub3:{es:"Skills:"},sub4:{es:"Experiencia Laboral:"},sub5:{es:"Últimos Proyectos:"},sub6:{es:"F.O.D.A"},sub7:{es:"Estudios"}},V=[{percent:72,content:{es:"Desarrollo (código)",en:"Desarrollo (código)"}},{percent:16,content:{es:"Levantamiento de definiciones funcionales, investigación, documentación y arquitectura",en:"Levantamiento de definiciones funcionales, investigación, documentación y arquitectura"}},{percent:12,content:{es:"Reuniones de coordinación, daylis y mentoría",en:"Reuniones de coordinación, daylis y mentoría"}}],A=[{icon:S,url:"https://github.com/ivanjoz/",name:"Github",user:"/ivanjoz"},{icon:D,url:"https://www.linkedin.com/in/anguloivan/",name:"LinkedIn",user:"/anguloivan"},{icon:b,url:"https://medium.com/@angivan",name:"Medium",user:"@angivan"}],I=[{desc:"Experiencia como Scrum Master en proyectos Agile",icon:y,order1:2},{desc:"Inglés avanzado y español nativo",icon:k,order1:1},{desc:"Experiencia en arquitectura cloud, AWS y DevOps",icon:w,order1:3,marginTop:-10},{desc:"Habilidades comunicativas y de coordinación",icon:f,order1:5,marginTop:-16},{desc:"Desarrollo enfocado en escabilidad y mantenibilidad en sistemas complejos",icon:v,order1:4}],U=[{es:"Git, Python, Kotlin y Flutter + Dart",en:""},{es:"AWS: Cloudformation, IAM, API-Gateway, CloudFront",en:""},{es:"Web APIs, Service Workers, PWA, WebSockets, Vite.js, Next.js",en:""},{es:"Cálculos geo-espaciales y renderización de mapas",en:""}],M=[{name:"Go Programming",years:[[22,6],[23,8],[24,8]]},{name:"C# & .NET Core",years:[[20,6],[21,4],[22,3]]},{name:"Solid.js",years:[[22,3],[23,4],[23,6]]},{name:"ScyllaDB / Cassandra",years:[[23,3],[24,4]]},{name:"Node.js",years:[[19,8],[20,8],[21,6],[22,5],[23,4]]},{name:"React.js",years:[[19,3],[20,5],[21,6],[22,8],[23,6],[23,4]]},{name:"Angular",years:[[20,8],[21,4]]},{name:"PostgreSQL",years:[[20,4],[21,5],[22,8],[23,7]]},{name:"SQL Server",years:[[17,4],[20,8],[21,4]]},{name:"Mongo DB, ArangoDB",years:[[18,7],[19,7]]},{name:"JavaScript / TypeScript",years:[[17,8],[18,7],[19,7],[20,7],[21,6],[22,6],[23,6],[24,6]]},{name:"Linux, Bash, Nginx, VPS",years:[[16,3],[17,3],[18,2],[19,1],[20,3],[21,2],[22,2],[23,2],[24,2]]},{name:"PHP, Wordpress",years:[[16,5],[17,4],[18,4]]},{name:"AWS Lambda, EC2, S3...",years:[[20,4],[21,4],[22,5],[23,6],[24,6]]},{name:"Docker / Podman",years:[[22,3],[23,6],[24,5]]},{name:"Rust",years:[[21,2],[23,4],[24,5]]},{name:"Google Cloud / Firebase",years:[[21,3],[22,4]]},{name:"DynamoDB",years:[[21,2],[22,2],[22,3],[24,4]]},{name:"Infra & CI/CD Tools",years:[[22,3],[23,3],[24,3]]},{name:"AWS Athena, Glue, ETLs",years:[[22,2],[23,3],[24,2]]}],H=[{company:"Hortifrut SA",years:[202211,-1],description:["Desarrollo de software empresarial para áreas de producción, sanidad y mejora contínua con React.js, Go, Node.js, PostgreSQL y DynamoDB","Desarrollo sobre servicios AWS como Lambda, S3, ECS, CloudFront, Athena, API-Gateway mediante SDK y CLI","Coordinación con múltiples áreas para el levantamiento técnico-funcional de los proyectos de software"],role:"Full Stack Developer",logo:d,pdfCardHeight:1.1},{company:"Yawi Solutions",role:"Senior Software Developer",years:[202003,202211],logo:p,pdfCardHeight:1.1,description:["Desarrollo de software empresarial con Angular, React.js + Vite.js, C# / .NET Core, Node.js y Go.","Modelado de base de datos Sql-Server y PostgreSQL","Manejo de librerías gráficas (web), estadísticas y geo-espaciales","Diseño de arquitectura cloud en AWS con CloudFormation y en Azure.","Lider técnico del equipo de Software Factory y rol como Scrum Master"]},{company:"Upwork",years:[201906,202003],logo:m,pdfCardHeight:.9,description:["Desarrollo de sistemas web con React, Node y MongoDB: Catálogo de cursos para institución educativa","Desarrollo de gestor de contenidos para páginas web con JavaScript","Desarrollo de sistema de búsqueda de empleo y scraping con React, Node.js y PostgreSQL"],role:"Freelance Software Developer"},{company:"Unicore",logo:h,years:[201804,201906],role:"Software Developer & Founder",pdfCardHeight:.95,description:["Desarrollo de sistema empresarial con módulos de ventas, finanzas, logística, productos y facturación electrónica usando PostgreSQL, DynamoDB, Node.js, React.js y WebSockets","Desarrollo de páginas webs con CMS e integración con plataformas de pago.","Uso de AWS Lambda, S3, EC2 y Linux VPCs y Bash"]},{company:"Permex International",logoImg:"images/permex4.webp",years:[201604,201802],role:"Jefe de Operaciones",pdfCardHeight:.9,description:["Planificación y control de la producción y el abastecimiento para la producción de chips de carnaza","Gestión de la logística internacional y trámites para la exportación de contenedores a USA","Elaboración de presupuestos, reportes de gastos y gestión financiera."]},{company:"EQUOM SAC",years:[201501,201603],logo:g,pdfCardHeight:.8,description:["Participación en desarrollo de CompuBox: Mini-PC Linux con procesador ARM","Coordinación con proveedores internacionales, gestión del proceso de importación y manejo financiero"],role:"Jefe de Operaciones"}],L=[{es:"Genix: Sistema de gestión para Mypes (Logística, Comercial, Finanzas)"},{es:"Librería de conversación de imagen .webp y .avif en Go con binarios precompilados hechos en Rust"},{es:"ORM para ScyllaDB / Cassandra hecho en Go"},{es:"SmartBerry. Sistema de gestión de producción agrícola de Hortifrut"},{es:"Jobfinder. Sistema de búsqueda de empleos y scraping"},{es:"Páginas web y CSM con React + Next.js"}],T=[{name:"FORTALEZAS",list:["Balance entre habilidades técnicas y blandas","Experiencia en varios lenguajes y framework permite adoptar nuevas herramientas rápido","Experiencia en arquitectura cloud / AWS","Background en negocios, finanzas y operaciones en empresas industriales","Experiencia desarrollando sobre bases de código grandes con equipos multidiciplinarios"]},{name:"DEBILIDADES",list:["Poca experiencia en kubernetes, MS-Windows y apps móviles","Poca experiencia en Python, AI y ciencia de datos","Tendencia de asumir el riesgo de incorporar nuevas tecnologías"]},{name:"OPORTUNIDADES",list:["Tecnologías actuales"]},{name:"AMENAZAS",list:["TBD"]}],F=[{name:"Platzi",carrer:"Desarrollo de Software",logo:x,years:"2019-2022",content:[`Cursos: JavaScript, TypeScript, ReactJS, Golang, Frontend Development,
    Back-end con NodeJs y ExpressJs. SCRUM. Arquitectura cloud con AWS.`]},{name:"Uni. Privada Antenor Orrego",carrer:"Maestría en Administración con Mención en Finanzas",logo:u,years:"2018-2019",content:[]},{name:"Uni. Privada del Norte",carrer:"Carrera de Administración y negocios internacionales",logo:z,years:"2009-2014",content:["Licenciado","Rendimiento: 5to Superior","Tesis: Reducción del precio CIF mediante el apalancamiento operativo-financiero."]}],O=`<?xml version="1.0" encoding="UTF-8"?>
...
`,q=n=>`data:image/svg+xml;charset=utf-8,${encodeURIComponent(n)}`,P=(n,s)=>{const t=new Map;let i=0;for(;i<=0;){const e=n.indexOf('fill="',i);if(e===-1)break;const a=n.indexOf('"',e+6),c=n.substring(e+6,a);t.set(`c-${c}`,[e,c,'fill="$"']),i=a+1}for(;i<=0;){const e=n.indexOf("fill:",i);if(e===-1)break;const a=n.indexOf(";",e+5),c=n.substring(e+5,a);t.set(`s-${c}`,[e,c,"fill:$"]),i=a+1}const r=Array.from(t.values()).sort((e,a)=>e[0]-a[0]);for(let e=0;e<r.length;e++){const a=s[e];if(!a)break;const[c,o,l]=r[e];n=n.replaceAll(l.replace("$",o),l.replace("$",a))}return n},G={1:{es:"Ene",en:"Jan"},2:{es:"Feb",en:"Feb"},3:{es:"Mar",en:"Mar"},4:{es:"Abr",en:"Apr"},5:{es:"May",en:"May"},6:{es:"Jun",en:"Jun"},7:{es:"Jul",en:"Jul"},8:{es:"Ago",en:"Ago"},9:{es:"Sep",en:"Sep"},10:{es:"Oct",en:"Oct"},11:{es:"Nov",en:"Nov"},12:{es:"Dic",en:"Dec"}},R=n=>{if(n===-1)return"Present";const s=String(n).substring(0,4),t=G[String(parseInt(String(n).substring(4,6)))];return`${_(t||"")} ${s}`},_=n=>typeof n=="string"?n:n.es||n.en,j=(n,s)=>{const t=new Map;let i=n.indexOf(">",n.indexOf("<svg")+1)+1;for(;i>-1;){const e='height="',a=n.indexOf(e,i);if(a===-1)break;i=n.indexOf('"',a+e.length);const c=n.substring(a+e.length,i),o=parseInt(c);if(isNaN(o)){console.log("isNaN",c,a,i);continue}t.set(`h-${o}`,[a,o,'height="$"'])}console.log("heightsMap",t);const r=Array.from(t.values()).sort((e,a)=>e[0]-a[0]);for(let e=0;e<r.length;e++){let a=s[e];if(!a)break;const[c,o,l]=r[e];a<=1&&(a=Math.floor(o*a*100)/100),n=n.replaceAll(l.replace("$",String(o)),l.replace("$",String(a)))}return console.log("svgContent",n,s),n},E=n=>{const s=[322.52,316.32,310.11,303.91,300.19];n=n||1;for(let t=0;t<s.length;t++)s[t]=Math.floor(s[t]*n);return`
  <?xml version="1.0" encoding="UTF-8"?>
  <!-- Created with Inkscape (http://www.inkscape.org/) -->
  <svg width="476" height="${s[0]}" version="1.1" viewBox="0 0 476 ${s[0]}" xmlns="http://www.w3.org/2000/svg">
   <g transform="translate(-24.443 -41.668)">
    <g fill="#222f6d">
     <rect x="24.443" y="41.668" width="476" height="${s[0]}" rx="20.826" ry="19.798" fill-opacity=".02" stroke-width=".88065"/>
     <rect x="28.443" y="44.769" width="468" height="${s[1]}" rx="21.419" ry="19.579" fill-opacity=".03" stroke-width=".86478"/>
     <rect x="31.443" y="47.87" width="462" height="${s[2]}" rx="18.437" ry="17.767" fill-opacity=".04" stroke-width=".85075"/>
     <rect x="34.443" y="50.971" width="456" height="${s[3]}" rx="15.785" ry="16.207" fill-opacity=".05" stroke-width=".83672"/>
    </g>
