import{n as w,B as L,t as s,h as e0,d as k,w as y0,m as k0,F as t,G as E,x as b}from"./web-CsdZQrJ0.js";import{d as u0}from"./pdf-export-CBsJwQLr.js";const _0=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
...
`,D0=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<!-- Created with Inkscape (http://www.inkscape.org/) -->
...
`,C0=`<?xml version="1.0" encoding="UTF-8"?>
...
<svg
   ...
   xmlns:svg="http://www.w3.org/2000/svg"><defs
     ...
     transform="translate(-5.4,-13.6)"><path
       ...
       id="path6" /></g></svg>
`,G0=`<?xml version="1.0" encoding="UTF-8"?>
...
`,A0=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
   version="1.1"
   x="0px"
   y="0px"
...
`,I0=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<!-- Created with Inkscape (http://www.inkscape.org/) -->
...
`,L0='<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><title>linkedin-flat</title><g id="Linkedin"><circle id="back" cx="256" cy="256" r="256" fill="#0076b2"/><g id="Linkedin-2" data-name="Linkedin"><path d="M116.3,207h59.47V398.16H116.3Zm29.75-95a34.45,34.45,0,1,1-34.47,34.45A34.46,34.46,0,0,1,146.05,112" fill="#fff"/><path d="M213,207h57v26.14h.82c7.92-15,27.31-30.88,56.21-30.88,60.16,0,71.27,39.59,71.27,91.07V398.16H338.9v-93c0-22.17-.38-50.69-30.87-50.69-30.91,0-35.63,24.16-35.63,49.1v94.55H213Z" fill="#fff"/></g></g></svg>',P0=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
   width="1024"
   height="1024"
...
`,H0=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
...
`,T0=[{percent:72,content:{es:"Desarrollo (código)",en:"Desarrollo (código)"}},{percent:16,content:{es:"Levantamiento de definiciones funcionales, investigación, documentación y arquitectura",en:"Levantamiento de definiciones funcionales, investigación, documentación y arquitectura"}},{percent:12,content:{es:"Reuniones de coordinación, daylis y mentoría",en:"Reuniones de coordinación, daylis y mentoría"}}],F0=[{icon:P0,url:"https://github.com/ivanjoz/"},{icon:L0,url:"https://www.linkedin.com/in/anguloivan/"},{icon:H0,url:"https://medium.com/@angivan"}],B0=[{desc:"Experiencia como Scrum Master en proyectos Agile",icon:A0},{desc:"Inglés avanzado y español nativo",icon:V0},{desc:"Experiencia en arquitectura cloud, AWS y DevOps",icon:$0},{desc:"Habilidades comunicativas y de coordinación",icon:C0},{desc:"Desarrollo enfocado en escabilidad y mantenibilidad en sistemas complejos",icon:G0}],q0=[{es:"Git, Python, Kotlin y Flutter + Dart",en:""},{es:"AWS: Cloudformation, IAM, API-Gateway, CloudFront",en:""},{es:"Web APIs, Service Workers, PWA, WebSockets, Vite.js, Next.js",en:""},{es:"Cálculos geo-espaciales y renderización de mapas",en:""}],E0=[{name:"Go Programming",years:[[22,6],[23,8],[24,8]]},{name:"C# & .NET Core",years:[[20,6],[21,4],[22,3]]},{name:"Solid.js",years:[[22,3],[23,4],[23,6]]},{name:"ScyllaDB / Cassandra",years:[[23,3],[24,4]]},{name:"Node.js",years:[[19,8],[20,8],[21,6],[22,5],[23,4]]},{name:"React.js",years:[[19,3],[20,5],[21,6],[22,8],[23,6],[23,4]]},{name:"Angular",years:[[20,8],[21,4]]},{name:"PostgreSQL",years:[[20,4],[21,5],[22,8],[23,7]]},{name:"SQL Server",years:[[17,4],[20,8],[21,4]]},{name:"Mongo DB, ArangoDB",years:[[18,7],[19,7]]},{name:"JavaScript / TypeScript",years:[[17,8],[18,7],[19,7],[20,7],[21,6],[22,6],[23,6],[24,6]]},{name:"Linux, Bash, Nginx, VPS",years:[[16,3],[17,3],[18,2],[19,1],[20,3],[21,2],[22,2],[23,2],[24,2]]},{name:"PHP, Wordpress",years:[[16,5],[17,4],[18,4]]},{name:"AWS Lambda, EC2, S3...",years:[[20,4],[21,4],[22,5],[23,6],[24,6]]},{name:"Docker / Podman",years:[[22,3],[23,6],[24,5]]},{name:"Rust",years:[[21,2],[23,4],[24,5]]},{name:"Google Cloud / Firebase",years:[[21,3],[22,4]]},{name:"DynamoDB",years:[[21,2],[22,2],[22,3],[24,4]]},{name:"Infra & CI/CD Tools",years:[[22,3],[23,3],[24,3]]},{name:"AWS Athena, Glue, ETLs",years:[[22,2],[23,3],[24,2]]}],O0=[{company:"Hortifrut SA",years:[202211,-1],description:["Desarrollo de software empresarial para áreas de producción, sanidad y mejora contínua con React.js, Go, Node.js, PostgreSQL y DynamoDB","Desarrollo sobre servicios AWS como Lambda, S3, ECS, CloudFront, Athena, API-Gateway mediante SDK y CLI","Coordinación con múltiples áreas para el levantamiento técnico-funcional de los proyectos de software"],role:"Full Stack Developer",logo:_0},{company:"Yawi Solutions",role:"Senior Software Developer",years:[202003,202211],logo:b0,description:["Desarrollo de software empresarial con Angular, React.js + Vite.js, C# / .NET Core, Node.js y Go.","Modelado de base de datos Sql-Server y PostgreSQL","Manejo de librerías gráficas (web), estadísticas y geo-espaciales","Diseño de arquitectura cloud en AWS con CloudFormation y en Azure.","Lider técnico del equipo de Software Factory y rol como Scrum Master"]},{company:"Upwork",years:[201906,202003],logo:z0,description:["Desarrollo de sistemas web con React, Node y MongoDB: Catálogo de cursos para institución educativa","Desarrollo de gestor de contenidos para páginas web con JavaScript","Desarrollo de sistema de búsqueda de empleo y scraping con React, Node.js y PostgreSQL"],role:"Freelance Software Developer"},{company:"Unicore",logo:S0,years:[201804,201906],role:"Software Developer & Founder",description:["Desarrollo de sistema empresarial con módulos de ventas, finanzas, logística, productos y facturación electrónica usando PostgreSQL, DynamoDB, Node.js, React.js y WebSockets","Desarrollo de páginas webs con CMS e integración con plataformas de pago.","Uso de AWS Lambda, S3, EC2 y Linux VPCs y Bash"]},{company:"Permex International",logoImg:"images/permex4.webp",years:[201604,201802],role:"Jefe de Operaciones",description:["Planificación y control de la producción y el abastecimiento para la producción de chips de carnaza","Gestión de la logística internacional y trámites para la exportación de contenedores a USA","Elaboración de presupuestos, reportes de gastos y gestión financiera."]},{company:"EQUOM SAC",years:[201501,201603],logo:D0,description:["Participación en desarrollo de CompuBox: Mini-PC Linux con procesador ARM","Coordinación con proveedores internacionales, gestión del proceso de importación y manejo financiero"],role:"Jefe de Operaciones"}],R0=[{es:"Genix: Sistema de gestión para Mypes (Logística, Comercial, Finanzas)"},{es:"Librería de conversación de imagen .webp y .avif en Go con binarios precompilados hechos en Rust"},{es:"ORM para ScyllaDB / Cassandra hecho en Go"},{es:"SmartBerry. Sistema de gestión de producción agrícola de Hortifrut"},{es:"Jobfinder. Sistema de búsqueda de empleos y scraping"},{es:"Páginas web y CSM con React + Next.js"}],j0=[{name:"FORTALEZAS",list:["Balance entre habilidades técnicas y blandas","Experiencia en varios lenguajes y framework permite adoptar nuevas herramientas rápido","Experiencia en arquitectura cloud / AWS","Background en negocios, finanzas y operaciones en empresas industriales","Experiencia desarrollando sobre bases de código grandes con equipos multidiciplinarios"]},{name:"DEBILIDADES",list:["Poca experiencia en kubernetes, MS-Windows y apps móviles","Poca experiencia en Python, AI y ciencia de datos","Tendencia de asumir el riesgo de incorporar nuevas tecnologías"]},{name:"OPORTUNIDADES",list:["Tecnologías actuales"]},{name:"AMENAZAS",list:["TBD"]}],W0=[{name:"Platzi",carrer:"Desarrollo de Software",logo:I0,years:"2019-2022",content:[`Cursos: JavaScript, TypeScript, ReactJS, Golang, Frontend Development,
    Back-end con NodeJs y ExpressJs. SCRUM. Arquitectura cloud con AWS.`]},{name:"Uni. Privada Antenor Orrego",carrer:"Maestría en Administración con Mención en Finanzas",logo:U0,years:"2018-2019",content:[]},{name:"Uni. Privada del Norte",carrer:"Carrera de Administración y negocios internacionales",logo:M0,years:"2009-2014",content:["Licenciado","Rendimiento: 5to Superior","Tesis: Reducción del precio CIF mediante el apalancamiento operativo-financiero."]}],N0="_",Z0="a",J0="b",Q0="c",K0="d",Y0="e",X0="f",n1="g",e1="h",t1="i",a1="j",i1="k",s1="l",c1="m",o1="n",l1="o",r1="p",d1="q",p1="r",m1="s",h1="t",g1="u",v1="v",f1="w",w1="x",y1="y",x1="z",k1="A",u1="B",_1="C",b1="D",z1="E",S1="F",D1="G",C1="H",$1="I",G1="J",A1="K",V1="L",I1="M",e={main:N0,content:Z0,experiencia_container:J0,title:Q0,dot:K0,dot_static:Y0,dot_line:X0,ivan_nombre:n1,experiencia1:e1,about_me_layer:t1,about_me_layer_inline:a1,photo_circle:i1,letter:s1,developer:c1,location:o1,location_container:l1,table_header:r1,table_cell:d1,cell_line:p1,table_main_container:m1,table_main:h1,table_cell_1:g1,email:v1,line_border:f1,table_card:w1,work_year:y1,table_card_container:x1,table_card_image_ctn:k1,table_card_image:u1,foda_card:_1,skill_card:b1,skill_image:z1,skill_descrip:S1,skill_card_container:D1,social_icon:C1,about_me:$1,email_icon:G1,tecnologias_container:A1,dot_container:V1,subtitle:I1},U1=`<?xml version="1.0" encoding="UTF-8"?>
...
`,M1=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
   viewBox="0 0 28 20"
   x="0px"
   y="0px"
...
`,O=c=>`data:image/svg+xml;charset=utf-8,${encodeURIComponent(c)}`;var x0=b("<div>"),L1=b("<div><div>"),P1=b('<div><!$><!/><!$><!/><div><div class="flex jc-between"><div></div><div><button>Download</button></div></div><h2>Tecnologías / Años de Experiencia</h2><div><div><table><thead><tr></tr></thead><tbody></tbody></table></div><div><div>Experiencia adicional en:</div><div class="w100 block-margin"></div><div></div><div>Día de trabajo habitual:</div><table><tbody></tbody></table></div></div><h2>Skills</h2><div></div><h2>Experiencia Laboral</h2><div></div><h2>Últimos Proyectos</h2><div class=block-margin></div><h2>F.O.D.A</h2><div></div><h2>Estudios</h2><div>'),H1=b("<th><div>"),T1=b("<tr>"),F1=b("<td>"),B1=b('<tr><td class="bold h3"></td><td class="">'),q1=b('<div><img alt=""><div>'),E1=b('<div><div class="bold h5 tt-c1 w100 ta-c"></div><!$><!/>'),i0=b('<div class="flex ai-start"><div></div> <!$><!/>'),O1=b('<div><div><div><img src=images/ivan-angulo-profile.webp alt="ivan angulo reyna profile"></div><div><h1>Iván J. Angulo</h1></div><div><img alt=""><div>Trujillo - Perú</div></div></div><div><div><h2>Software Developer FullStack</h2></div><div>5+ años de experiencia desarrollando sistemas cloud con Node.Js, Go y C# y AWS, Linux, frontend con React y bases de datos SQL.</div><div class=flex></div><div><img alt=""><div><a href=mailto:ivan@un.pe>ivan@un.pe'),R1=b('<div><img alt="">'),j1=b('<div><div><div><img alt=""></div><div><div class="h2 bold tt-c1"></div><div></div><div></div></div></div><div class=block-margin>'),W1=b('<div><div><div><img alt=""></div><div><div class="h2 bold tt-c1"></div><div></div><div></div></div></div><div class=block-margin4>'),N1=b("<div><!$><!/><div></div><!$><!/>");const Z1=17,J1=24,t0=c=>typeof c=="string"?c:c.es||c.en;function e2(){const c=[{name:"",setContent:o=>(()=>{var l=w(x0);return s(l,()=>o.name),k(()=>t(l,e.table_cell_1)),l})()}];for(let o=Z1;o<=J1;o++)c.push({name:`${o}`,headerCss:e.table_header,cellCss:e.table_cell,setContent:l=>{const g=l.years.find(y=>y[0]===o);if(!g)return null;let d=0;return d=(g[1]-1)*2,d<3&&(d=3),d>18&&(d=18),(()=>{var y=w(L1),v=y.firstChild;return y.style.setProperty("height","100%"),y.style.setProperty("position","relative"),`${d}px`!=null?v.style.setProperty("height",`${d}px`):v.style.removeProperty("height"),k(()=>t(v,e.cell_line)),y})()}});return(()=>{var o=w(P1),l=o.firstChild,[g,d]=L(l.nextSibling),y=g.nextSibling,[v,u]=L(y.nextSibling),C=v.nextSibling,$=C.firstChild,a=$.firstChild,m=a.nextSibling,p=m.firstChild,_=$.nextSibling,x=_.nextSibling,h=x.firstChild,G=h.firstChild,Z=G.firstChild,i=Z.firstChild,A=Z.nextSibling,P=h.nextSibling,S=P.firstChild,I=S.nextSibling,U=I.nextSibling,R=U.nextSibling,J=R.nextSibling,Q=J.firstChild,j=x.nextSibling,F=j.nextSibling,W=F.nextSibling,B=W.nextSibling,N=B.nextSibling,q=N.nextSibling,s0=q.nextSibling,a0=s0.nextSibling,c0=a0.nextSibling,o0=c0.nextSibling;return s(o,e0(v0,{get css(){return e.about_me_layer}}),g,d),s(o,e0(v0,{get css(){return e.about_me_layer_inline}}),v,u),p.$$click=n=>{n.stopPropagation(),u0()},s(i,()=>c.map(n=>(()=>{var r=w(H1),f=r.firstChild;return s(f,()=>n.name),k(()=>t(f,n.headerCss)),r})())),s(A,()=>E0.map(n=>(()=>{var r=w(T1);return s(r,()=>c.map(f=>(()=>{var D=w(F1);return s(D,()=>f.setContent(n)),k(()=>t(D,f.cellCss)),D})())),r})())),s(I,()=>q0.map((n,r)=>w0(n,r))),s(Q,()=>T0.map(n=>(()=>{var r=w(B1),f=r.firstChild,D=f.nextSibling;return s(f,()=>`${n.percent}%`),s(D,()=>t0(n.content)),r})())),s(F,()=>B0.map(n=>(()=>{var r=w(q1),f=r.firstChild,D=f.nextSibling;return s(D,()=>t0(n.desc)),k(z=>{var H=`${e.skill_card}`,T=`${e.skill_image}`,V=O(n.icon),M=`${e.skill_descrip}`;return H!==z.e&&t(r,z.e=H),T!==z.t&&t(f,z.t=T),V!==z.a&&E(f,"src",z.a=V),M!==z.o&&t(D,z.o=M),z},{e:void 0,t:void 0,a:void 0,o:void 0}),r})())),s(B,()=>O0.map(n=>e0(K1,{args:n}))),q.style.setProperty("padding-left","0.8rem"),s(q,()=>R0.map((n,r)=>w0(n,r))),s(a0,()=>j0.map(n=>(()=>{var r=w(E1),f=r.firstChild,D=f.nextSibling,[z,H]=L(D.nextSibling);return s(f,()=>n.name),s(r,()=>n.list.map(T=>(()=>{var V=w(i0),M=V.firstChild,K=M.nextSibling,Y=K.nextSibling,[X,n0]=L(Y.nextSibling);return s(V,T,X,n0),k(()=>t(M,`${e.dot_static}`)),V})()),z,H),k(()=>t(r,`block-margin4 ${e.foda_card}`)),r})())),s(o0,()=>W0.map(n=>e0(Y1,{args:n}))),k(n=>{var r=e.main,f=e.content,D=`bold ${e.title}`,z=`flex w100 ${e.tecnologias_container}`,H=e.table_main_container,T=`w100 ${e.table_main}`,V=`flex ${e.experiencia_container}`,M=`bold h3 tt-c1 mb-06 ${e.subtitle}`,K=`${e.line_border}`,Y=`bold h3 tt-c1 mb-06 ${e.subtitle}`,X=`bold ${e.title}`,n0=`flex ${e.skill_card_container}`,l0=`bold ${e.title}`,r0=e.table_card_container,d0=`bold ${e.title}`,p0=`bold ${e.title}`,m0=`${e.table_card_container}`,h0=`bold ${e.title}`,g0=e.table_card_container;return r!==n.e&&t(o,n.e=r),f!==n.t&&t(C,n.t=f),D!==n.a&&t(_,n.a=D),z!==n.o&&t(x,n.o=z),H!==n.i&&t(h,n.i=H),T!==n.n&&t(G,n.n=T),V!==n.s&&t(P,n.s=V),M!==n.h&&t(S,n.h=M),K!==n.r&&t(U,n.r=K),Y!==n.d&&t(R,n.d=Y),X!==n.l&&t(j,n.l=X),n0!==n.u&&t(F,n.u=n0),l0!==n.c&&t(W,n.c=l0),r0!==n.w&&t(B,n.w=r0),d0!==n.m&&t(N,n.m=d0),p0!==n.f&&t(s0,n.f=p0),m0!==n.y&&t(a0,n.y=m0),h0!==n.g&&t(c0,n.g=h0),g0!==n.p&&t(o0,n.p=g0),n},{e:void 0,t:void 0,a:void 0,o:void 0,i:void 0,n:void 0,s:void 0,h:void 0,r:void 0,d:void 0,l:void 0,u:void 0,c:void 0,w:void 0,m:void 0,f:void 0,y:void 0,g:void 0,p:void 0}),y0(),o})()}const v0=c=>(()=>{var o=w(O1),l=o.firstChild,g=l.firstChild,d=g.nextSibling,y=d.firstChild,v=d.nextSibling,u=v.firstChild,C=u.nextSibling,$=l.nextSibling,a=$.firstChild,m=a.firstChild,p=a.nextSibling,_=p.nextSibling,x=_.nextSibling,h=x.firstChild,G=h.nextSibling,Z=G.firstChild;return u.style.setProperty("margin-right","3px"),u.style.setProperty("width","1rem"),u.style.setProperty("height","1rem"),p.style.setProperty("padding","8px"),p.style.setProperty("text-align","center"),s(_,()=>F0.map(i=>(()=>{var A=w(R1),P=A.firstChild;return A.$$click=S=>{S.stopPropagation(),window.open(i.url)},k(S=>{var I=e.social_icon,U=O(i.icon);return I!==S.e&&t(A,S.e=I),U!==S.t&&E(P,"src",S.t=U),S},{e:void 0,t:void 0}),y0(),A})())),h.style.setProperty("margin-right","6px"),h.style.setProperty("width","1rem"),h.style.setProperty("height","1rem"),k(i=>{var A=c.css,P=e.photo_circle,S=`${e.letter}`,I=`h1 bold ${e.ivan_nombre}`,U=`flex ${e.location_container}`,R=O(U1),J=`${e.location}`,Q=`${e.letter} ${e.developer}`,j=`h22 bold ${e.experiencia1}`,F=`${e.letter} ${e.about_me}`,W=`flex ${e.email_icon}`,B=O(M1),N=`h3 ${e.location}`,q=`${e.email}`;return A!==i.e&&t(o,i.e=A),P!==i.t&&t(g,i.t=P),S!==i.a&&t(d,i.a=S),I!==i.o&&t(y,i.o=I),U!==i.i&&t(v,i.i=U),R!==i.n&&E(u,"src",i.n=R),J!==i.s&&t(C,i.s=J),Q!==i.h&&t(a,i.h=Q),j!==i.r&&t(m,i.r=j),F!==i.d&&t(p,i.d=F),W!==i.l&&t(x,i.l=W),B!==i.u&&E(h,"src",i.u=B),N!==i.c&&t(G,i.c=N),q!==i.w&&t(Z,i.w=q),i},{e:void 0,t:void 0,a:void 0,o:void 0,i:void 0,n:void 0,s:void 0,h:void 0,r:void 0,d:void 0,l:void 0,u:void 0,c:void 0,w:void 0}),o})(),Q1={1:{es:"Ene",en:"Jan"},2:{es:"Feb",en:"Feb"},3:{es:"Mar",en:"Mar"},4:{es:"Abr",en:"Apr"},5:{es:"May",en:"May"},6:{es:"Jun",en:"Jun"},7:{es:"Jul",en:"Jul"},8:{es:"Ago",en:"Ago"},9:{es:"Sep",en:"Sep"},10:{es:"Oct",en:"Oct"},11:{es:"Nov",en:"Nov"},12:{es:"Dic",en:"Dec"}},f0=c=>{if(c===-1)return"Present";const o=String(c).substring(0,4),l=Q1[String(parseInt(String(c).substring(4,6)))];return`${t0(l||"")} ${o}`},K1=c=>(()=>{var o=w(j1),l=o.firstChild,g=l.firstChild,d=g.firstChild,y=g.nextSibling,v=y.firstChild,u=v.nextSibling,C=u.nextSibling,$=l.nextSibling;return l.style.setProperty("display","flex"),s(v,()=>c.args.company),s(u,()=>c.args.role),s(C,()=>`${f0(c.args.years[0])} - ${f0(c.args.years[1])}`),s($,()=>c.args.description.map(a=>(()=>{var m=w(i0),p=m.firstChild,_=p.nextSibling,x=_.nextSibling,[h,G]=L(x.nextSibling);return s(m,a,h,G),k(()=>t(p,`${e.dot_static}`)),m})())),k(a=>{var m=e.table_card,p=e.table_card_image_ctn,_=e.table_card_image,x=c.args.logoImg||O(c.args.logo),h=`bold ${e.work_year}`;return m!==a.e&&t(o,a.e=m),p!==a.t&&t(g,a.t=p),_!==a.a&&t(d,a.a=_),x!==a.o&&E(d,"src",a.o=x),h!==a.i&&t(C,a.i=h),a},{e:void 0,t:void 0,a:void 0,o:void 0,i:void 0}),o})(),Y1=c=>(()=>{var o=w(W1),l=o.firstChild,g=l.firstChild,d=g.firstChild,y=g.nextSibling,v=y.firstChild,u=v.nextSibling,C=u.nextSibling,$=l.nextSibling;return l.style.setProperty("display","flex"),s(v,()=>c.args.name),s(u,()=>c.args.carrer),s(C,()=>c.args.years),s($,()=>c.args.content.map(a=>(()=>{var m=w(i0),p=m.firstChild,_=p.nextSibling,x=_.nextSibling,[h,G]=L(x.nextSibling);return s(m,a,h,G),k(()=>t(p,`${e.dot_static}`)),m})())),k(a=>{var m=e.table_card,p=e.table_card_image_ctn,_=e.table_card_image,x=O(c.args.logo),h=`bold ${e.work_year}`;return m!==a.e&&t(o,a.e=m),p!==a.t&&t(g,a.t=p),_!==a.a&&t(d,a.a=_),x!==a.o&&E(d,"src",a.o=x),h!==a.i&&t(C,a.i=h),a},{e:void 0,t:void 0,a:void 0,o:void 0,i:void 0}),o})(),w0=(c,o)=>(()=>{var l=w(N1),g=l.firstChild,[d,y]=L(g.nextSibling),v=d.nextSibling,u=v.nextSibling,[C,$]=L(u.nextSibling);return s(l,o!==0&&(()=>{var a=w(x0);return k(()=>t(a,`${e.dot_line}`)),a})(),d,y),s(l,()=>t0(c),C,$),k(a=>{var m=`flex ai-start ${e.dot_container}`,p=`${e.dot}`;return m!==a.e&&t(l,a.e=m),p!==a.t&&t(v,a.t=p),a},{e:void 0,t:void 0}),l})();k0(["click"]);export{e2 as default};
