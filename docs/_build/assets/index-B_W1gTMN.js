import{n as f,B as M,t as s,h as e0,d as x,m as v0,F as t,G as O,w as f0,x as _}from"./web-CsdZQrJ0.js";const w0=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
...
`,y0=`<?xml version="1.0" encoding="UTF-8"?>
...
`,b0=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
   version="1.1"
   x="0px"
   y="0px"
...
`,G0=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
   width="362.61874"
   height="373.60001"
...
`,U0=[{percent:72,content:{es:"Desarrollo (código)",en:"Desarrollo (código)"}},{percent:16,content:{es:"Levantamiento de definiciones funcionales, investigación, documentación y arquitectura",en:"Levantamiento de definiciones funcionales, investigación, documentación y arquitectura"}},{percent:12,content:{es:"Reuniones de coordinación, daylis y mentoría",en:"Reuniones de coordinación, daylis y mentoría"}}],M0=[{icon:V0,url:"https://github.com/ivanjoz/"},{icon:A0,url:"https://www.linkedin.com/in/anguloivan/"},{icon:I0,url:"https://medium.com/@angivan"}],L0=[{desc:"Experiencia como Scrum Master en proyectos Agile",icon:S0},{desc:"Inglés avanzado y español nativo",icon:D0},{desc:"Experiencia en arquitectura cloud, AWS y DevOps",icon:b0},{desc:"Habilidades comunicativas y de coordinación",icon:_0},{desc:"Desarrollo enfocado en escabilidad y mantenibilidad en sistemas complejos",icon:z0}],P0=[{es:"Git, Python, Kotlin y Flutter + Dart",en:""},{es:"AWS: Cloudformation, IAM, API-Gateway, CloudFront",en:""},{es:"Web APIs, Service Workers, PWA, WebSockets, Vite.js, Next.js",en:""},{es:"Cálculos geo-espaciales y renderización de mapas",en:""}],H0=[{name:"Go Programming",years:[[22,6],[23,8],[24,8]]},{name:"C# & .NET Core",years:[[20,6],[21,4],[22,3]]},{name:"Solid.js",years:[[22,3],[23,4],[23,6]]},{name:"ScyllaDB / Cassandra",years:[[23,3],[24,4]]},{name:"Node.js",years:[[19,8],[20,8],[21,6],[22,5],[23,4]]},{name:"React.js",years:[[19,3],[20,5],[21,6],[22,8],[23,6],[23,4]]},{name:"Angular",years:[[20,8],[21,4]]},{name:"PostgreSQL",years:[[20,4],[21,5],[22,8],[23,7]]},{name:"SQL Server",years:[[17,4],[20,8],[21,4]]},{name:"Mongo DB, ArangoDB",years:[[18,7],[19,7]]},{name:"JavaScript / TypeScript",years:[[17,8],[18,7],[19,7],[20,7],[21,6],[22,6],[23,6],[24,6]]},{name:"Linux, Bash, Nginx, VPS",years:[[16,3],[17,3],[18,2],[19,1],[20,3],[21,2],[22,2],[23,2],[24,2]]},{name:"PHP, Wordpress",years:[[16,5],[17,4],[18,4]]},{name:"AWS Lambda, EC2, S3...",years:[[20,4],[21,4],[22,5],[23,6],[24,6]]},{name:"Docker / Podman",years:[[22,3],[23,6],[24,5]]},{name:"Rust",years:[[21,2],[23,4],[24,5]]},{name:"Google Cloud / Firebase",years:[[21,3],[22,4]]},{name:"DynamoDB",years:[[21,2],[22,2],[22,3],[24,4]]},{name:"Infra & CI/CD Tools",years:[[22,3],[23,3],[24,3]]},{name:"AWS Athena, Glue, ETLs",years:[[22,2],[23,3],[24,2]]}],T0=[{company:"Hortifrut SA",years:[202211,-1],description:["Desarrollo de software empresarial para áreas de producción, sanidad y mejora contínua con React.js, Go, Node.js, PostgreSQL y DynamoDB","Desarrollo sobre servicios AWS como Lambda, S3, ECS, CloudFront, Athena, API-Gateway mediante SDK y CLI","Coordinación con múltiples áreas para el levantamiento técnico-funcional de los proyectos de software"],role:"Full Stack Developer",logo:w0},{company:"Yawi Solutions",role:"Senior Software Developer",years:[202003,202211],logo:y0,description:["Desarrollo de software empresarial con Angular, React.js + Vite.js, C# / .NET Core, Node.js y Go.","Modelado de base de datos Sql-Server y PostgreSQL","Manejo de librerías gráficas (web), estadísticas y geo-espaciales","Diseño de arquitectura cloud en AWS con CloudFormation y en Azure.","Lider técnico del equipo de Software Factory y rol como Scrum Master"]},{company:"Upwork",years:[201906,202203],logo:x0,description:["Desarrollo de sistemas web con React, Node y MongoDB: Catálogo de cursos para institución educativa","Desarrollo de gestor de contenidos para páginas web con JavaScript","Desarrollo de sistema de búsqueda de empleo y scraping con React, Node.js y PostgreSQL"],role:"Freelance Software Developer"},{company:"Unicore",logo:k0,years:[201804,201906],role:"Software Developer & Founder",description:["Desarrollo de sistema empresarial con módulos de ventas, finanzas, logística, productos y facturación electrónica usando PostgreSQL, DynamoDB, Node.js, React.js y WebSockets","Desarrollo de páginas webs con CMS e integración con plataformas de pago.","Uso de AWS Lambda, S3, EC2 y Linux VPCs y Bash"]},{company:"Permex International",logoImg:"images/permex4.webp",years:[201604,201802],role:"Jefe de Operaciones",description:["Planificación y control de la producción y el abastecimiento para la producción de chips de carnaza","Gestión de la logística internacional y trámites para la exportación de contenedores a USA","Elaboración de presupuestos, reportes de gastos y gestión financiera."]},{company:"EQUOM SAC",years:[201501,201603],logo:u0,description:["Participación en desarrollo de CompuBox: Mini-PC Linux con procesador ARM","Coordinación con proveedores internacionales, gestión del proceso de importación y manejo financiero"],role:"Jefe de Operaciones"}],F0=[{es:"Genix: Sistema de gestión para Mypes (Logística, Comercial, Finanzas)"},{es:"Librería de conversación de imagen .webp y .avif en Go con binarios precompilados hechos en Rust"},{es:"ORM para ScyllaDB / Cassandra hecho en Go"},{es:"SmartBerry. Sistema de gestión de producción agrícola de Hortifrut"},{es:"Jobfinder. Sistema de búsqueda de empleos y scraping"},{es:"Páginas web y CSM con React + Next.js"}],B0=[{name:"FORTALEZAS",list:["Balance entre habilidades técnicas y blandas","Experiencia en varios lenguajes y framework permite adoptar nuevas herramientas rápido","Experiencia en arquitectura cloud / AWS","Background en negocios, finanzas y operaciones en empresas industriales","Experiencia desarrollando sobre bases de código grandes con equipos multidiciplinarios"]},{name:"DEBILIDADES",list:["Poca experiencia en kubernetes, MS-Windows y apps móviles","Poca experiencia en Python, AI y ciencia de datos","Tendencia de asumir el riesgo de incorporar nuevas tecnologías"]},{name:"OPORTUNIDADES",list:["Tecnologías actuales"]},{name:"AMENAZAS",list:["TBD"]}],q0=[{name:"Platzi",carrer:"Desarrollo de Software",logo:C0,years:"2019-2022",content:[`Cursos: JavaScript, TypeScript, ReactJS, Golang, Frontend Development,
    Back-end con NodeJs y ExpressJs. SCRUM. Arquitectura cloud con AWS.`]},{name:"Uni. Privada Antenor Orrego",carrer:"Maestría en Administración con Mención en Finanzas",logo:$0,years:"2018-2019",content:[]},{name:"Uni. Privada del Norte",carrer:"Carrera de Administración y negocios internacionales",logo:G0,years:"2009-2014",content:["Licenciado","Rendimiento: 5to Superior","Tesis: Reducción del precio CIF mediante el apalancamiento operativo-financiero."]}],E0="_",O0="a",R0="b",j0="c",W0="d",N0="e",Z0="f",J0="g",Q0="h",K0="i",Y0="j",X0="k",n1="l",e1="m",t1="n",a1="o",i1="p",s1="q",c1="r",o1="s",l1="t",r1="u",d1="v",p1="w",m1="x",h1="y",g1="z",v1="A",f1="B",w1="C",y1="D",x1="E",k1="F",u1="G",_1="H",b1="I",z1="J",S1="K",D1="L",C1="M",e={main:E0,content:O0,experiencia_container:R0,title:j0,dot:W0,dot_static:N0,dot_line:Z0,ivan_nombre:J0,experiencia1:Q0,about_me_layer:K0,about_me_layer_inline:Y0,photo_circle:X0,letter:n1,developer:e1,location:t1,location_container:a1,table_header:i1,table_cell:s1,cell_line:c1,table_main_container:o1,table_main:l1,table_cell_1:r1,email:d1,line_border:p1,table_card:m1,work_year:h1,table_card_container:g1,table_card_image_ctn:v1,table_card_image:f1,foda_card:w1,skill_card:y1,skill_image:x1,skill_descrip:k1,skill_card_container:u1,social_icon:_1,about_me:b1,email_icon:z1,tecnologias_container:S1,dot_container:D1,subtitle:C1},$1=`<?xml version="1.0" encoding="UTF-8"?>
...
`,R=c=>`data:image/svg+xml;charset=utf-8,${encodeURIComponent(c)}`;var g0=_("<div>"),A1=_("<div><div>"),V1=_('<div><!$><!/><!$><!/><div><h2>Tecnologías / Años de Experiencia</h2><div><div><table><thead><tr></tr></thead><tbody></tbody></table></div><div><div>Experiencia adicional en:</div><div class="w100 block-margin"></div><div></div><div>Día de trabajo habitual:</div><table><tbody></tbody></table></div></div><h2>Skills</h2><div></div><h2>Experiencia Laboral</h2><div></div><h2>Últimos Proyectos</h2><div class=block-margin></div><h2>F.O.D.A</h2><div></div><h2>Estudios</h2><div>'),I1=_("<th><div>"),U1=_("<tr>"),M1=_("<td>"),L1=_('<tr><td class="bold h3"></td><td class="">'),P1=_('<div><img alt=""><div>'),H1=_('<div><div class="bold h5 tt-c1 w100 ta-c"></div><!$><!/>'),a0=_('<div class="flex ai-start"><div></div> <!$><!/>'),T1=_('<div><div><div><img src=images/ivan-angulo-profile.webp alt="ivan angulo reyna profile"></div><div><h1>Iván J. Angulo</h1></div><div><img alt=""><div>Trujillo - Perú</div></div></div><div><div><h2>Software Developer FullStack</h2></div><div>5+ años de experiencia desarrollando sistemas cloud con Node.Js, Go y C# y AWS, Linux, frontend con React y bases de datos SQL.</div><div class=flex></div><div><img alt=""><div><a href=mailto:ivan@un.pe>ivan@un.pe'),F1=_('<div><img alt="">'),B1=_('<div><div><div><img alt=""></div><div><div class="h2 bold tt-c1"></div><div></div><div></div></div></div><div class=block-margin>'),q1=_('<div><div><div><img alt=""></div><div><div class="h2 bold tt-c1"></div><div></div><div></div></div></div><div class=block-margin4>'),E1=_("<div><!$><!/><div></div><!$><!/>");const O1=17,R1=24,t0=c=>typeof c=="string"?c:c.es||c.en;function J1(){const c=[{name:"",setContent:o=>(()=>{var l=f(g0);return s(l,()=>o.name),x(()=>t(l,e.table_cell_1)),l})()}];for(let o=O1;o<=R1;o++)c.push({name:`${o}`,headerCss:e.table_header,cellCss:e.table_cell,setContent:l=>{const h=l.years.find(y=>y[0]===o);if(!h)return null;let d=0;return d=(h[1]-1)*2,d<3&&(d=3),d>18&&(d=18),(()=>{var y=f(A1),g=y.firstChild;return y.style.setProperty("height","100%"),y.style.setProperty("position","relative"),`${d}px`!=null?g.style.setProperty("height",`${d}px`):g.style.removeProperty("height"),x(()=>t(g,e.cell_line)),y})()}});return(()=>{var o=f(V1),l=o.firstChild,[h,d]=M(l.nextSibling),y=h.nextSibling,[g,k]=M(y.nextSibling),D=g.nextSibling,$=D.firstChild,a=$.nextSibling,p=a.firstChild,m=p.firstChild,u=m.firstChild,b=u.firstChild,w=u.nextSibling,A=p.nextSibling,Q=A.firstChild,i=Q.nextSibling,G=i.nextSibling,L=G.nextSibling,C=L.nextSibling,P=C.firstChild,I=a.nextSibling,F=I.nextSibling,j=F.nextSibling,B=j.nextSibling,W=B.nextSibling,q=W.nextSibling,N=q.nextSibling,E=N.nextSibling,Z=E.nextSibling,J=Z.nextSibling;return s(o,e0(p0,{get css(){return e.about_me_layer}}),h,d),s(o,e0(p0,{get css(){return e.about_me_layer_inline}}),g,k),s(b,()=>c.map(n=>(()=>{var r=f(I1),v=r.firstChild;return s(v,()=>n.name),x(()=>t(v,n.headerCss)),r})())),s(w,()=>H0.map(n=>(()=>{var r=f(U1);return s(r,()=>c.map(v=>(()=>{var S=f(M1);return s(S,()=>v.setContent(n)),x(()=>t(S,v.cellCss)),S})())),r})())),s(i,()=>P0.map((n,r)=>h0(n,r))),s(P,()=>U0.map(n=>(()=>{var r=f(L1),v=r.firstChild,S=v.nextSibling;return s(v,()=>`${n.percent}%`),s(S,()=>t0(n.content)),r})())),s(F,()=>L0.map(n=>(()=>{var r=f(P1),v=r.firstChild,S=v.nextSibling;return s(S,()=>t0(n.desc)),x(z=>{var H=`${e.skill_card}`,T=`${e.skill_image}`,V=R(n.icon),U=`${e.skill_descrip}`;return H!==z.e&&t(r,z.e=H),T!==z.t&&t(v,z.t=T),V!==z.a&&O(v,"src",z.a=V),U!==z.o&&t(S,z.o=U),z},{e:void 0,t:void 0,a:void 0,o:void 0}),r})())),s(B,()=>T0.map(n=>e0(W1,{args:n}))),q.style.setProperty("padding-left","0.8rem"),s(q,()=>F0.map((n,r)=>h0(n,r))),s(E,()=>B0.map(n=>(()=>{var r=f(H1),v=r.firstChild,S=v.nextSibling,[z,H]=M(S.nextSibling);return s(v,()=>n.name),s(r,()=>n.list.map(T=>(()=>{var V=f(a0),U=V.firstChild,K=U.nextSibling,Y=K.nextSibling,[X,n0]=M(Y.nextSibling);return s(V,T,X,n0),x(()=>t(U,`${e.dot_static}`)),V})()),z,H),x(()=>t(r,`block-margin4 ${e.foda_card}`)),r})())),s(J,()=>q0.map(n=>e0(N1,{args:n}))),x(n=>{var r=e.main,v=e.content,S=`bold ${e.title}`,z=`flex w100 ${e.tecnologias_container}`,H=e.table_main_container,T=`w100 ${e.table_main}`,V=`flex ${e.experiencia_container}`,U=`bold h3 tt-c1 mb-06 ${e.subtitle}`,K=`${e.line_border}`,Y=`bold h3 tt-c1 mb-06 ${e.subtitle}`,X=`bold ${e.title}`,n0=`flex ${e.skill_card_container}`,i0=`bold ${e.title}`,s0=e.table_card_container,c0=`bold ${e.title}`,o0=`bold ${e.title}`,l0=`${e.table_card_container}`,r0=`bold ${e.title}`,d0=e.table_card_container;return r!==n.e&&t(o,n.e=r),v!==n.t&&t(D,n.t=v),S!==n.a&&t($,n.a=S),z!==n.o&&t(a,n.o=z),H!==n.i&&t(p,n.i=H),T!==n.n&&t(m,n.n=T),V!==n.s&&t(A,n.s=V),U!==n.h&&t(Q,n.h=U),K!==n.r&&t(G,n.r=K),Y!==n.d&&t(L,n.d=Y),X!==n.l&&t(I,n.l=X),n0!==n.u&&t(F,n.u=n0),i0!==n.c&&t(j,n.c=i0),s0!==n.w&&t(B,n.w=s0),c0!==n.m&&t(W,n.m=c0),o0!==n.f&&t(N,n.f=o0),l0!==n.y&&t(E,n.y=l0),r0!==n.g&&t(Z,n.g=r0),d0!==n.p&&t(J,n.p=d0),n},{e:void 0,t:void 0,a:void 0,o:void 0,i:void 0,n:void 0,s:void 0,h:void 0,r:void 0,d:void 0,l:void 0,u:void 0,c:void 0,w:void 0,m:void 0,f:void 0,y:void 0,g:void 0,p:void 0}),o})()}const p0=c=>(()=>{var o=f(T1),l=o.firstChild,h=l.firstChild,d=h.nextSibling,y=d.firstChild,g=d.nextSibling,k=g.firstChild,D=k.nextSibling,$=l.nextSibling,a=$.firstChild,p=a.firstChild,m=a.nextSibling,u=m.nextSibling,b=u.nextSibling,w=b.firstChild,A=w.nextSibling,Q=A.firstChild;return k.style.setProperty("margin-right","3px"),k.style.setProperty("width","1rem"),k.style.setProperty("height","1rem"),m.style.setProperty("padding","8px"),m.style.setProperty("text-align","center"),s(u,()=>M0.map(i=>(()=>{var G=f(F1),L=G.firstChild;return G.$$click=C=>{C.stopPropagation(),window.open(i.url)},x(C=>{var P=e.social_icon,I=R(i.icon);return P!==C.e&&t(G,C.e=P),I!==C.t&&O(L,"src",C.t=I),C},{e:void 0,t:void 0}),f0(),G})())),w.style.setProperty("margin-right","6px"),w.style.setProperty("width","1rem"),w.style.setProperty("height","1rem"),x(i=>{var G=c.css,L=e.photo_circle,C=`${e.letter}`,P=`h1 bold ${e.ivan_nombre}`,I=`flex ${e.location_container}`,F=R($1),j=`${e.location}`,B=`${e.letter} ${e.developer}`,W=`h22 bold ${e.experiencia1}`,q=`${e.letter} ${e.about_me}`,N=`flex ${e.email_icon}`,E=R(G1),Z=`h3 ${e.location}`,J=`${e.email}`;return G!==i.e&&t(o,i.e=G),L!==i.t&&t(h,i.t=L),C!==i.a&&t(d,i.a=C),P!==i.o&&t(y,i.o=P),I!==i.i&&t(g,i.i=I),F!==i.n&&O(k,"src",i.n=F),j!==i.s&&t(D,i.s=j),B!==i.h&&t(a,i.h=B),W!==i.r&&t(p,i.r=W),q!==i.d&&t(m,i.d=q),N!==i.l&&t(b,i.l=N),E!==i.u&&O(w,"src",i.u=E),Z!==i.c&&t(A,i.c=Z),J!==i.w&&t(Q,i.w=J),i},{e:void 0,t:void 0,a:void 0,o:void 0,i:void 0,n:void 0,s:void 0,h:void 0,r:void 0,d:void 0,l:void 0,u:void 0,c:void 0,w:void 0}),o})(),j1={1:{es:"Ene",en:"Jan"},2:{es:"Feb",en:"Feb"},3:{es:"Mar",en:"Mar"},4:{es:"Abr",en:"Apr"},5:{es:"May",en:"May"},6:{es:"Jun",en:"Jun"},7:{es:"Jul",en:"Jul"},8:{es:"Ago",en:"Ago"},9:{es:"Sep",en:"Sep"},10:{es:"Oct",en:"Oct"},11:{es:"Nov",en:"Nov"},12:{es:"Dic",en:"Dec"}},m0=c=>{if(c===-1)return"Present";const o=String(c).substring(0,4),l=j1[String(parseInt(String(c).substring(4,6)))];return`${t0(l||"")} ${o}`},W1=c=>(()=>{var o=f(B1),l=o.firstChild,h=l.firstChild,d=h.firstChild,y=h.nextSibling,g=y.firstChild,k=g.nextSibling,D=k.nextSibling,$=l.nextSibling;return l.style.setProperty("display","flex"),s(g,()=>c.args.company),s(k,()=>c.args.role),s(D,()=>`${m0(c.args.years[0])} - ${m0(c.args.years[1])}`),s($,()=>c.args.description.map(a=>(()=>{var p=f(a0),m=p.firstChild,u=m.nextSibling,b=u.nextSibling,[w,A]=M(b.nextSibling);return s(p,a,w,A),x(()=>t(m,`${e.dot_static}`)),p})())),x(a=>{var p=e.table_card,m=e.table_card_image_ctn,u=e.table_card_image,b=c.args.logoImg||R(c.args.logo),w=`bold ${e.work_year}`;return p!==a.e&&t(o,a.e=p),m!==a.t&&t(h,a.t=m),u!==a.a&&t(d,a.a=u),b!==a.o&&O(d,"src",a.o=b),w!==a.i&&t(D,a.i=w),a},{e:void 0,t:void 0,a:void 0,o:void 0,i:void 0}),o})(),N1=c=>(()=>{var o=f(q1),l=o.firstChild,h=l.firstChild,d=h.firstChild,y=h.nextSibling,g=y.firstChild,k=g.nextSibling,D=k.nextSibling,$=l.nextSibling;return l.style.setProperty("display","flex"),s(g,()=>c.args.name),s(k,()=>c.args.carrer),s(D,()=>c.args.years),s($,()=>c.args.content.map(a=>(()=>{var p=f(a0),m=p.firstChild,u=m.nextSibling,b=u.nextSibling,[w,A]=M(b.nextSibling);return s(p,a,w,A),x(()=>t(m,`${e.dot_static}`)),p})())),x(a=>{var p=e.table_card,m=e.table_card_image_ctn,u=e.table_card_image,b=R(c.args.logo),w=`bold ${e.work_year}`;return p!==a.e&&t(o,a.e=p),m!==a.t&&t(h,a.t=m),u!==a.a&&t(d,a.a=u),b!==a.o&&O(d,"src",a.o=b),w!==a.i&&t(D,a.i=w),a},{e:void 0,t:void 0,a:void 0,o:void 0,i:void 0}),o})(),h0=(c,o)=>(()=>{var l=f(E1),h=l.firstChild,[d,y]=M(h.nextSibling),g=d.nextSibling,k=g.nextSibling,[D,$]=M(k.nextSibling);return s(l,o!==0&&(()=>{var a=f(g0);return x(()=>t(a,`${e.dot_line}`)),a})(),d,y),s(l,()=>t0(c),D,$),x(a=>{var p=`flex ai-start ${e.dot_container}`,m=`${e.dot}`;return p!==a.e&&t(l,a.e=p),m!==a.t&&t(g,a.t=m),a},{e:void 0,t:void 0}),l})();v0(["click"]);export{J1 as default};
