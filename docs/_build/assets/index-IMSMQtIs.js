import{n as h,B as M,t as i,h as n0,d as k,m as m0,F as t,G as O,w as h0,x as u}from"./web-CsdZQrJ0.js";const g0=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
...
`,y0=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<!-- Created with Inkscape (http://www.inkscape.org/) -->
...
`,_0=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
   version="1.1"
   x="0px"
   y="0px"
...
`,C0='<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><title>linkedin-flat</title><g id="Linkedin"><circle id="back" cx="256" cy="256" r="256" fill="#0076b2"/><g id="Linkedin-2" data-name="Linkedin"><path d="M116.3,207h59.47V398.16H116.3Zm29.75-95a34.45,34.45,0,1,1-34.47,34.45A34.46,34.46,0,0,1,146.05,112" fill="#fff"/><path d="M213,207h57v26.14h.82c7.92-15,27.31-30.88,56.21-30.88,60.16,0,71.27,39.59,71.27,91.07V398.16H338.9v-93c0-22.17-.38-50.69-30.87-50.69-30.91,0-35.63,24.16-35.63,49.1v94.55H213Z" fill="#fff"/></g></g></svg>',$0=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
   width="1024"
   height="1024"
...
`,V0=[{percent:72,content:{es:"Desarrollo (código)",en:"Desarrollo (código)"}},{percent:16,content:{es:"Levantamiento de definiciones funcionales, investigación, documentación y arquitectura",en:"Levantamiento de definiciones funcionales, investigación, documentación y arquitectura"}},{percent:12,content:{es:"Reuniones de coordinación, daylis y mentoría",en:"Reuniones de coordinación, daylis y mentoría"}}],A0=[{icon:$0,url:"https://github.com/ivanjoz/"},{icon:C0,url:"https://www.linkedin.com/in/anguloivan/"},{icon:G0,url:"https://medium.com/@angivan"}],U0=[{desc:"Experiencia como Scrum Master en proyectos Agile",icon:_0},{desc:"Inglés avanzado y español nativo",icon:z0},{desc:"Experiencia en arquitectura cloud, AWS y DevOps",icon:k0},{desc:"Habilidades comunicativas y de coordinación",icon:x0},{desc:"Desarrollo enfocado en escabilidad y mantenibilidad en sistemas complejos",icon:u0}],I0=[{es:"Git, Python, Kotlin y Flutter + Dart",en:""},{es:"AWS: Cloudformation, IAM, API-Gateway, CloudFront",en:""},{es:"Vite.js, Next.js, Service Workers, PWA, WebSockets",en:""},{es:"Cálculos geo-espaciales y renderización de mapas",en:""}],P0=[{name:"Go Programming",years:[[22,6],[23,8],[24,8]]},{name:"C# & .NET Core",years:[[20,6],[21,4],[22,3]]},{name:"Solid.js",years:[[22,3],[23,4],[23,6]]},{name:"ScyllaDB / Cassandra",years:[[23,3],[24,4]]},{name:"Node.js",years:[[19,8],[20,8],[21,6],[22,5],[23,4]]},{name:"React.js",years:[[19,3],[20,5],[21,6],[22,8],[23,6],[23,4]]},{name:"Angular",years:[[20,8],[21,4]]},{name:"PostgreSQL",years:[[20,4],[21,5],[22,8],[23,7]]},{name:"SQL Server",years:[[17,4],[20,8],[21,4]]},{name:"Mongo DB, ArangoDB",years:[[18,7],[19,7]]},{name:"JavaScript & WebAPIs",years:[[17,8],[18,7],[19,7],[20,7],[21,6],[22,6],[23,6],[24,6]]},{name:"Linux, Bash, Nginx, VPS",years:[[16,3],[17,3],[18,2],[19,1],[20,3],[21,2],[22,2],[23,2],[24,2]]},{name:"PHP, Wordpress",years:[[16,5],[17,4],[18,4]]},{name:"AWS Lambda, EC2, S3...",years:[[20,4],[21,4],[22,5],[23,6],[24,6]]},{name:"Docker / Podman",years:[[22,3],[23,6],[24,5]]},{name:"Rust",years:[[21,2],[23,4],[24,5]]},{name:"Google Cloud / Firebase",years:[[21,3],[22,4]]},{name:"DynamoDB",years:[[21,2],[22,2],[22,3],[24,4]]},{name:"Infra & CI/CD Tools",years:[[22,3],[23,3],[24,3]]},{name:"AWS Athena, Glue, ETLs",years:[[22,2],[23,3],[24,2]]}],L0=[{company:"Hortifrut SA",description:["Desarrollo de software empresarial para áreas de producción, sanidad y mejora contínua con React.js, Go, Node.js, PostgreSQL y DynamoDB","Desarrollo sobre servicios AWS como Lambda, S3, ECS, CloudFront, Athena, API-Gateway mediante SDK y CLI","Coordinación con múltiples áreas para el levantamiento técnico-funcional de los proyectos de software"],role:"Full Stack Developer",logo:g0},{company:"Yawi Solutions",role:"Senior Software Developer",logo:f0,description:["Desarrollo de software empresarial con Angular, React.js + Vite.js, C# / .NET Core, Node.js y Go.","Modelado de base de datos Sql-Server y PostgreSQL","Manejo de librerías gráficas (web), estadísticas y geo-espaciales","Diseño de arquitectura cloud en AWS con CloudFormation y en Azure.","Lider técnico del equipo de Software Factory y rol como Scrum Master"]},{company:"Upwork",logo:v0,description:["Desarrollo de sistemas web con React, Node y MongoDB: Catálogo de cursos para institución educativa","Desarrollo de gestor de contenidos para páginas web con JavaScript","Desarrollo de sistema de búsqueda de empleo y scraping con React, Node.js y PostgreSQL"],role:"Freelance Software Developer"},{company:"Unicore",logo:w0,role:"Software Developer & Founder",description:["Desarrollo de sistema empresarial con módulos de ventas, finanzas, logística, productos y facturación electrónica usando PostgreSQL, DynamoDB, Node.js, React.js y WebSockets","Desarrollo de páginas webs con CMS e integración con plataformas de pago.","Uso de AWS Lambda, S3, EC2 y Linux VPCs y Bash"]},{company:"Permex International",logoImg:"images/permex4.webp",role:"Jefe de Operaciones",description:["Planificación y control de la producción y el abastecimiento para la producción de chips de carnaza","Gestión de la logística internacional y trámites para la exportación de contenedores a USA","Elaboración de presupuestos, reportes de gastos y gestión financiera."]},{company:"EQUOM SAC",logo:y0,description:["Participación en desarrollo de CompuBox: Mini-PC Linux con procesador ARM","Coordinación con proveedores internacionales, gestión del proceso de importación y manejo financiero"],role:"Jefe de Operaciones"}],M0=[{es:"Genix: Sistema de gestión para Mypes (Logística, Comercial, Finanzas)"},{es:"Librería de conversación de imagen .webp y .avif en Go con binarios precompilados hechos en Rust"},{es:"ORM para ScyllaDB / Cassandra hecho en Go"},{es:"SmartBerry. Sistema de gestión de producción agrícola de Hortifrut"},{es:"Jobfinder. Sistema de búsqueda de empleos y scraping"},{es:"Páginas web y CSM con React + Next.js"}],H0=[{name:"FORTALEZAS",list:["Balance entre habilidades técnicas y blandas","Experiencia en varios lenguajes y framework permite adoptar nuevas herramientas rápido","Experiencia en arquitectura cloud / AWS","Background en negocios, finanzas y operaciones en empresas industriales","Experiencia desarrollando sobre bases de código grandes con equipos multidiciplinarios"]},{name:"DEBILIDADES",list:["Poca experiencia en kubernetes, MS-Windows y apps móviles","Poca experiencia en Python, AI y ciencia de datos","Tendencia de asumir el riesgo de incorporar nuevas tecnologías"]},{name:"OPORTUNIDADES",list:["Tecnologías actuales"]},{name:"AMENAZAS",list:["TBD"]}],T0=[{name:"Platzi",logo:b0,content:[]},{name:"Uni. Privada Antenor Orrego",logo:S0,content:[]},{name:"Uni. Privada del Norte",logo:D0,content:[]}],F0="_",B0="a",q0="b",E0="c",O0="d",R0="e",j0="f",W0="g",Z0="h",N0="i",Q0="j",J0="k",K0="l",Y0="m",X0="n",n1="o",e1="p",t1="q",a1="r",i1="s",s1="t",c1="u",o1="v",l1="w",r1="x",d1="y",p1="z",m1="A",h1="B",g1="C",f1="D",v1="E",w1="F",e={main:F0,content:B0,dot:q0,ivan_nombre:E0,experiencia1:O0,about_me_layer:R0,about_me_layer_inline:j0,photo_circle:W0,letter:Z0,developer:N0,location:Q0,location_container:J0,table_header:K0,table_cell:Y0,cell_line:X0,table_main_container:n1,table_main:e1,table_cell_1:t1,email:a1,table_card:i1,table_card_container:s1,table_card_image_ctn:c1,table_card_image:o1,foda_card:l1,skill_card:r1,skill_image:d1,skill_descrip:p1,skill_card_container:m1,social_icon:h1,about_me:g1,email_icon:f1,tecnologias_container:v1,title:w1},y1=`<?xml version="1.0" encoding="UTF-8"?>
...
`,x1=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
   viewBox="0 0 28 20"
   x="0px"
   y="0px"
...
`,R=o=>`data:image/svg+xml;charset=utf-8,${encodeURIComponent(o)}`;var r0=u("<div>"),k1=u("<div><div>"),u1=u('<div><!$><!/><!$><!/><div><h2>Tecnologías / Años de Experiencia</h2><div><div><table><thead><tr></tr></thead><tbody></tbody></table></div><div><div class="bold h3 tt-c1">Experiencia adicional en:</div><!$><!/><div></div><div class="bold h3 tt-c1">Día de trabajo habitual:</div><table><tbody></tbody></table></div></div><h2>Skills</h2><div></div><h2>Experiencia Laboral</h2><div></div><h2>Últimos Proyectos</h2><div></div><h2>F.O.D.A</h2><div></div><h2>Estudios</h2><div>'),_1=u("<th><div>"),z1=u("<tr>"),b1=u("<td>"),S1=u('<div class="flex ai-start"><div></div><div>'),D1=u('<tr><td class="bold h3"></td><td class="">'),C1=u('<div><img alt=""><div>'),$1=u('<div class="flex ai-start"><div></div><!$><!/>'),G1=u('<div><div class="bold h5 tt-c1 w100 ta-c"></div><!$><!/>'),d0=u('<div class="flex ai-start"><div></div> <!$><!/>'),V1=u('<div><div><div><img src=images/ivan-angulo-profile.webp alt="ivan angulo reyna profile"></div><div><h1>Iván J. Angulo</h1></div><div><img alt=""><div>Trujillo - Perú</div></div></div><div><div><h2>Software Developer FullStack</h2></div><div>5+ años de experiencia desarrollando sistemas cloud con Node.Js, Go y C# y AWS, Linux, frontend con React y bases de datos SQL.</div><div class=flex></div><div><img alt=""><div><a href=mailto:ivan@un.pe>ivan@un.pe'),A1=u('<div><img alt="">'),p0=u('<div><div><div><img alt=""></div><div><div class="h2 bold tt-c1"></div><div></div></div></div><div>');const U1=17,I1=24,e0=o=>typeof o=="string"?o:o.es||o.en;function H1(){const o=[{name:"",setContent:l=>(()=>{var m=h(r0);return i(m,()=>l.name),k(()=>t(m,e.table_cell_1)),m})()}];for(let l=U1;l<=I1;l++)o.push({name:`${l}`,headerCss:e.table_header,cellCss:e.table_cell,setContent:m=>{const f=m.years.find(_=>_[0]===l);if(!f)return null;let p=0;return p=(f[1]-1)*2,p<3&&(p=3),p>18&&(p=18),(()=>{var _=h(k1),w=_.firstChild;return _.style.setProperty("height","100%"),_.style.setProperty("position","relative"),`${p}px`!=null?w.style.setProperty("height",`${p}px`):w.style.removeProperty("height"),k(()=>t(w,e.cell_line)),_})()}});return(()=>{var l=h(u1),m=l.firstChild,[f,p]=M(m.nextSibling),_=f.nextSibling,[w,S]=M(_.nextSibling),A=w.nextSibling,s=A.firstChild,d=s.nextSibling,z=d.firstChild,y=z.firstChild,b=y.firstChild,H=b.firstChild,C=b.nextSibling,$=z.nextSibling,t0=$.firstChild,a=t0.nextSibling,[D,T]=M(a.nextSibling),x=D.nextSibling,I=x.nextSibling,P=I.nextSibling,Q=P.firstChild,j=d.nextSibling,F=j.nextSibling,W=F.nextSibling,B=W.nextSibling,Z=B.nextSibling,q=Z.nextSibling,N=q.nextSibling,E=N.nextSibling,a0=E.nextSibling,i0=a0.nextSibling;return i(l,n0(l0,{get css(){return e.about_me_layer}}),f,p),i(l,n0(l0,{get css(){return e.about_me_layer_inline}}),w,S),i(H,()=>o.map(n=>(()=>{var c=h(_1),r=c.firstChild;return i(r,()=>n.name),k(()=>t(r,n.headerCss)),c})())),i(C,()=>P0.map(n=>(()=>{var c=h(z1);return i(c,()=>o.map(r=>(()=>{var g=h(b1);return i(g,()=>r.setContent(n)),k(()=>t(g,r.cellCss)),g})())),c})())),$.style.setProperty("flex-grow","1"),$.style.setProperty("margin-left","1vw"),$.style.setProperty("display","flex"),$.style.setProperty("flex-direction","column"),i($,()=>I0.map(n=>(()=>{var c=h(S1),r=c.firstChild,g=r.nextSibling;return i(g,()=>e0(n)),k(()=>t(r,`${e.dot}`)),c})()),D,T),x.style.setProperty("width","100%"),x.style.setProperty("border-bottom","1px solid black"),x.style.setProperty("margin","12px 0"),i(Q,()=>V0.map(n=>(()=>{var c=h(D1),r=c.firstChild,g=r.nextSibling;return i(r,()=>`${n.percent}%`),i(g,()=>e0(n.content)),c})())),i(F,()=>U0.map(n=>(()=>{var c=h(C1),r=c.firstChild,g=r.nextSibling;return i(g,()=>e0(n.desc)),k(v=>{var G=`${e.skill_card}`,L=`${e.skill_image}`,V=R(n.icon),U=`${e.skill_descrip}`;return G!==v.e&&t(c,v.e=G),L!==v.t&&t(r,v.t=L),V!==v.a&&O(r,"src",v.a=V),U!==v.o&&t(g,v.o=U),v},{e:void 0,t:void 0,a:void 0,o:void 0}),c})())),i(B,()=>L0.map(n=>n0(P1,{args:n}))),q.style.setProperty("padding-left","0.8rem"),i(q,()=>M0.map(n=>(()=>{var c=h($1),r=c.firstChild,g=r.nextSibling,[v,G]=M(g.nextSibling);return i(c,()=>e0(n),v,G),k(()=>t(r,`${e.dot}`)),c})())),i(E,()=>H0.map(n=>(()=>{var c=h(G1),r=c.firstChild,g=r.nextSibling,[v,G]=M(g.nextSibling);return i(r,()=>n.name),i(c,()=>n.list.map(L=>(()=>{var V=h(d0),U=V.firstChild,J=U.nextSibling,K=J.nextSibling,[Y,X]=M(K.nextSibling);return i(V,L,Y,X),k(()=>t(U,`${e.dot}`)),V})()),v,G),k(()=>t(c,e.foda_card)),c})())),i(i0,()=>T0.map(n=>n0(L1,{args:n}))),k(n=>{var c=e.main,r=e.content,g=`bold ${e.title}`,v=`flex w100 ${e.tecnologias_container}`,G=e.table_main_container,L=`w100 ${e.table_main}`,V=`bold ${e.title}`,U=`flex ${e.skill_card_container}`,J=`bold ${e.title}`,K=e.table_card_container,Y=`bold ${e.title}`,X=`bold ${e.title}`,s0=e.table_card_container,c0=`bold ${e.title}`,o0=e.table_card_container;return c!==n.e&&t(l,n.e=c),r!==n.t&&t(A,n.t=r),g!==n.a&&t(s,n.a=g),v!==n.o&&t(d,n.o=v),G!==n.i&&t(z,n.i=G),L!==n.n&&t(y,n.n=L),V!==n.s&&t(j,n.s=V),U!==n.h&&t(F,n.h=U),J!==n.r&&t(W,n.r=J),K!==n.d&&t(B,n.d=K),Y!==n.l&&t(Z,n.l=Y),X!==n.u&&t(N,n.u=X),s0!==n.c&&t(E,n.c=s0),c0!==n.w&&t(a0,n.w=c0),o0!==n.m&&t(i0,n.m=o0),n},{e:void 0,t:void 0,a:void 0,o:void 0,i:void 0,n:void 0,s:void 0,h:void 0,r:void 0,d:void 0,l:void 0,u:void 0,c:void 0,w:void 0,m:void 0}),l})()}const l0=o=>(()=>{var l=h(V1),m=l.firstChild,f=m.firstChild,p=f.nextSibling,_=p.firstChild,w=p.nextSibling,S=w.firstChild,A=S.nextSibling,s=m.nextSibling,d=s.firstChild,z=d.firstChild,y=d.nextSibling,b=y.nextSibling,H=b.nextSibling,C=H.firstChild,$=C.nextSibling,t0=$.firstChild;return S.style.setProperty("margin-right","3px"),S.style.setProperty("width","1rem"),S.style.setProperty("height","1rem"),y.style.setProperty("padding","8px"),y.style.setProperty("text-align","center"),i(b,()=>A0.map(a=>(()=>{var D=h(A1),T=D.firstChild;return D.$$click=x=>{x.stopPropagation(),window.open(a.url)},k(x=>{var I=e.social_icon,P=R(a.icon);return I!==x.e&&t(D,x.e=I),P!==x.t&&O(T,"src",x.t=P),x},{e:void 0,t:void 0}),h0(),D})())),C.style.setProperty("margin-right","6px"),C.style.setProperty("width","1rem"),C.style.setProperty("height","1rem"),k(a=>{var D=o.css,T=e.photo_circle,x=`${e.letter}`,I=`h1 bold ${e.ivan_nombre}`,P=`flex ${e.location_container}`,Q=R(y1),j=`${e.location}`,F=`${e.letter} ${e.developer}`,W=`h22 bold ${e.experiencia1}`,B=`${e.letter} ${e.about_me}`,Z=`flex ${e.email_icon}`,q=R(x1),N=`h3 ${e.location}`,E=`${e.email}`;return D!==a.e&&t(l,a.e=D),T!==a.t&&t(f,a.t=T),x!==a.a&&t(p,a.a=x),I!==a.o&&t(_,a.o=I),P!==a.i&&t(w,a.i=P),Q!==a.n&&O(S,"src",a.n=Q),j!==a.s&&t(A,a.s=j),F!==a.h&&t(d,a.h=F),W!==a.r&&t(z,a.r=W),B!==a.d&&t(y,a.d=B),Z!==a.l&&t(H,a.l=Z),q!==a.u&&O(C,"src",a.u=q),N!==a.c&&t($,a.c=N),E!==a.w&&t(t0,a.w=E),a},{e:void 0,t:void 0,a:void 0,o:void 0,i:void 0,n:void 0,s:void 0,h:void 0,r:void 0,d:void 0,l:void 0,u:void 0,c:void 0,w:void 0}),l})(),P1=o=>(console.log("logo:: ",o.args.logo),(()=>{var l=h(p0),m=l.firstChild,f=m.firstChild,p=f.firstChild,_=f.nextSibling,w=_.firstChild,S=w.nextSibling,A=m.nextSibling;return m.style.setProperty("display","flex"),i(w,()=>o.args.company),i(S,()=>o.args.role),i(A,()=>o.args.description.map(s=>(()=>{var d=h(d0),z=d.firstChild,y=z.nextSibling,b=y.nextSibling,[H,C]=M(b.nextSibling);return i(d,s,H,C),k(()=>t(z,`${e.dot}`)),d})())),k(s=>{var d=e.table_card,z=e.table_card_image_ctn,y=e.table_card_image,b=o.args.logoImg||R(o.args.logo);return d!==s.e&&t(l,s.e=d),z!==s.t&&t(f,s.t=z),y!==s.a&&t(p,s.a=y),b!==s.o&&O(p,"src",s.o=b),s},{e:void 0,t:void 0,a:void 0,o:void 0}),l})()),L1=o=>(console.log("logo:: ",o.args.logo),(()=>{var l=h(p0),m=l.firstChild,f=m.firstChild,p=f.firstChild,_=f.nextSibling,w=_.firstChild,S=w.nextSibling,A=m.nextSibling;return m.style.setProperty("display","flex"),i(w,()=>o.args.name),i(S,()=>o.args.content),i(A,()=>o.args.content.map(s=>(()=>{var d=h(r0);return i(d,s),d})())),k(s=>{var d=e.table_card,z=e.table_card_image_ctn,y=e.table_card_image,b=R(o.args.logo);return d!==s.e&&t(l,s.e=d),z!==s.t&&t(f,s.t=z),y!==s.a&&t(p,s.a=y),b!==s.o&&O(p,"src",s.o=b),s},{e:void 0,t:void 0,a:void 0,o:void 0}),l})());m0(["click"]);export{H1 as default};
