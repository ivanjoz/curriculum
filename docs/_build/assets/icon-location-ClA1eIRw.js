const C=n=>`data:image/svg+xml;charset=utf-8,${encodeURIComponent(n)}`,A=(n,t)=>{const s=new Map;let c=0;for(;c<=0;){const a=n.indexOf('fill="',c);if(a===-1)break;const e=n.indexOf('"',a+6),i=n.substring(a+6,e);s.set(`c-${i}`,[a,i,'fill="$"']),c=e+1}for(;c<=0;){const a=n.indexOf("fill:",c);if(a===-1)break;const e=n.indexOf(";",a+5),i=n.substring(a+5,e);s.set(`s-${i}`,[a,i,"fill:$"]),c=e+1}const r=Array.from(s.values()).sort((a,e)=>a[0]-e[0]);for(let a=0;a<r.length;a++){const e=t[a];if(!e)break;const[i,o,l]=r[a];n=n.replaceAll(l.replace("$",o),l.replace("$",e))}return n},d={1:{es:"Ene",en:"Jan"},2:{es:"Feb",en:"Feb"},3:{es:"Mar",en:"Mar"},4:{es:"Abr",en:"Apr"},5:{es:"May",en:"May"},6:{es:"Jun",en:"Jun"},7:{es:"Jul",en:"Jul"},8:{es:"Ago",en:"Ago"},9:{es:"Sep",en:"Sep"},10:{es:"Oct",en:"Oct"},11:{es:"Nov",en:"Nov"},12:{es:"Dic",en:"Dec"}},V=n=>{if(n===-1)return"Present";const t=String(n).substring(0,4),s=d[String(parseInt(String(n).substring(4,6)))];return`${p(s||"")} ${t}`},p=n=>typeof n=="string"?n:n.es||n.en,I=(n,t)=>{const s=new Map;let c=n.indexOf(">",n.indexOf("<svg")+1)+1;for(;c>-1;){const a='height="',e=n.indexOf(a,c);if(e===-1)break;c=n.indexOf('"',e+a.length);const i=n.substring(e+a.length,c),o=parseInt(i);if(isNaN(o)){console.log("isNaN",i,e,c);continue}s.set(`h-${o}`,[e,o,'height="$"'])}console.log("heightsMap",s);const r=Array.from(s.values()).sort((a,e)=>a[0]-e[0]);for(let a=0;a<r.length;a++){let e=t[a];if(!e)break;const[i,o,l]=r[a];e<=1&&(e=Math.floor(o*e*100)/100),n=n.replaceAll(l.replace("$",String(o)),l.replace("$",String(e)))}return console.log("svgContent",n,t),n},M=n=>{const t=[322.52,316.32,310.11,303.91,300.19];n=n||1;for(let s=0;s<t.length;s++)t[s]=Math.floor(t[s]*n);return`
  <?xml version="1.0" encoding="UTF-8"?>
  <!-- Created with Inkscape (http://www.inkscape.org/) -->
  <svg width="476" height="${t[0]}" version="1.1" viewBox="0 0 476 ${t[0]}" xmlns="http://www.w3.org/2000/svg">
   <g transform="translate(-24.443 -41.668)">
    <g fill="#222f6d">
     <rect x="24.443" y="41.668" width="476" height="${t[0]}" rx="20.826" ry="19.798" fill-opacity=".02" stroke-width=".88065"/>
     <rect x="28.443" y="44.769" width="468" height="${t[1]}" rx="21.419" ry="19.579" fill-opacity=".03" stroke-width=".86478"/>
     <rect x="31.443" y="47.87" width="462" height="${t[2]}" rx="18.437" ry="17.767" fill-opacity=".04" stroke-width=".85075"/>
     <rect x="34.443" y="50.971" width="456" height="${t[3]}" rx="15.785" ry="16.207" fill-opacity=".05" stroke-width=".83672"/>
    </g>
    <rect x="36.443" y="52.832" width="452" height="${t[4]}" rx="13.663" ry="14.922" fill="#f7f8fd" stroke-width=".82792"/>
   </g>
  </svg> 
...
`,G=`<svg data-name="Layer 1" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><circle cx="256" cy="256" r="256" fill="#0076b2"/><path d="M116.3 207h59.5v191.2h-59.5Zm29.8-95a34.5 34.5 0 1 1-34.5 34.5A34.5 34.5 0 0 1 146 112m67 95h57v26.1h.8c8-15 27.3-30.8 56.2-30.8 60.2 0 71.3 39.5 71.3 91v104.9h-59.4v-93c0-22.2-.4-50.7-30.9-50.7-30.9 0-35.6 24.1-35.6 49v94.6H213Z" fill="#fff" data-name="Linkedin"/></svg>
`,b=`<svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024"><path fill-rule="evenodd" clip-rule="evenodd" d="M512 0C229.12 0 0 229.12 0 512c0 226.56 146.56 417.92 350.08 485.76H675.2A512.64 512.64 0 0 0 1024 512C1024 229.12 794.88 0 512 0" fill="#1b1f23"/><path d="M350.08 997.76c1.075.188 1.96.146 2.979.265zm321.889.355c1.1-.148 2.064-.122 3.23-.355zm0 0C648.914 1001.212 640 986.267 640 973.44c0-17.28.64-72.318.64-140.798 0-48-16-78.721-34.56-94.721 113.92-12.8 233.6-56.321 233.6-252.8 0-56.32-19.84-101.76-52.48-137.6 5.12-12.8 23.04-65.28-5.12-135.68 0 0-42.88-14.08-140.8 52.48-40.96-11.52-84.48-17.28-128-17.28s-87.04 5.76-128 17.28c-97.92-65.92-140.8-52.48-140.8-52.48-28.16 70.4-10.24 122.88-5.12 135.68-32.64 35.84-52.48 81.92-52.48 137.6 0 195.839 119.04 240 232.96 252.8-14.72 12.8-28.16 35.2-32.64 68.48-29.44 13.44-103.04 35.2-149.12-42.24-9.6-15.36-38.4-53.12-78.72-52.48-42.88.64-17.28 24.32.64 33.92 21.76 12.16 46.72 57.6 52.48 72.32 10.24 28.8 43.52 83.84 172.16 60.16 0 42.88.64 83.2.64 95.36 0 12.875-8.974 27.317-32.221 24.585a500.6 500.6 0 0 0 159.574 27.192 500.6 500.6 0 0 0 159.336-27.102" fill="#fff"/></svg>
`,_=`<svg xmlns="http://www.w3.org/2000/svg" class="prefix__aa prefix__bb" viewBox="0 0 1261.8 1261.8"><circle cx="630.9" cy="630.9" r="630.9"/><g data-name="Layer 2"><path fill="#f9f9f9" d="M688.1 652.4a295.3 295.3 0 0 1-294.4 296.3A295.4 295.4 0 0 1 99.4 652.4 295.4 295.4 0 0 1 393.7 356a295.3 295.3 0 0 1 294.4 296.4m322.9 0c0 154-66 279-147.2 279-81.3 0-147.2-125-147.2-279s65.9-279 147.2-279 147.2 124.9 147.2 279m132 0c0 138-23.1 249.9-51.7 249.9s-51.8-112-51.8-250 23.2-249.8 51.9-249.8 51.7 112 51.7 250" data-name="Layer 1"/></g></svg>
`,U={tecnologias:{es:"Tecnologías / Años de Experiencia"},descripcion:{es:"5+ años de experiencia desarrollando sistemas cloud con Node.Js, Go y C# y AWS, Linux, frontend con React y bases de datos SQL."},sub1:{es:"Experiencia adicional en:"},sub2:{es:"Día de trabajo habitual:"},sub3:{es:"Skills:"},sub4:{es:"Experiencia Laboral:"},sub5:{es:"Últimos Proyectos:"},sub6:{es:"F.O.D.A"},sub7:{es:"Estudios"}},H=[{percent:72,content:{es:"Desarrollo (código)",en:"Desarrollo (código)"}},{percent:16,content:{es:"Levantamiento de definiciones funcionales, investigación, documentación y arquitectura",en:"Levantamiento de definiciones funcionales, investigación, documentación y arquitectura"}},{percent:12,content:{es:"Reuniones de coordinación, daylis y mentoría",en:"Reuniones de coordinación, daylis y mentoría"}}],L=[{icon:b,url:"https://github.com/ivanjoz/",name:"Github",user:"/ivanjoz"},{icon:G,url:"https://www.linkedin.com/in/anguloivan/",name:"LinkedIn",user:"/anguloivan"},{icon:_,url:"https://medium.com/@angivan",name:"Medium",user:"@angivan"}],T=[{desc:"Experiencia como Scrum Master en proyectos Agile",icon:k,order1:2},{desc:"Inglés avanzado y español nativo",icon:u,order1:1},{desc:"Experiencia en arquitectura cloud, AWS y DevOps",icon:y,order1:3,marginTop:-10},{desc:"Habilidades comunicativas y de coordinación",icon:v,order1:5,marginTop:-16},{desc:"Desarrollo enfocado en escabilidad y mantenibilidad en sistemas complejos",icon:x,order1:4}],O=[{es:"Git, Python, Kotlin y Flutter + Dart",en:""},{es:"AWS: Cloudformation, IAM, API-Gateway, CloudFront",en:""},{es:"Web APIs, Service Workers, PWA, WebSockets, Vite.js, Next.js",en:""},{es:"Cálculos geo-espaciales y renderización de mapas",en:""}],F=[{name:"Go Programming",years:[[22,6],[23,8],[24,8]]},{name:"C# & .NET Core",years:[[20,6],[21,4],[22,3]]},{name:"Solid.js",years:[[22,3],[23,4],[23,6]]},{name:"ScyllaDB / Cassandra",years:[[23,3],[24,4]]},{name:"Node.js",years:[[19,8],[20,8],[21,6],[22,5],[23,4]]},{name:"React.js",years:[[19,3],[20,5],[21,6],[22,8],[23,6],[23,4]]},{name:"Angular",years:[[20,8],[21,4]]},{name:"PostgreSQL",years:[[20,4],[21,5],[22,8],[23,7]]},{name:"SQL Server",years:[[17,4],[20,8],[21,4]]},{name:"Mongo DB, ArangoDB",years:[[18,7],[19,7]]},{name:"JavaScript / TypeScript",years:[[17,8],[18,7],[19,7],[20,7],[21,6],[22,6],[23,6],[24,6]]},{name:"Linux, Bash, Nginx, VPS",years:[[16,3],[17,3],[18,2],[19,1],[20,3],[21,2],[22,2],[23,2],[24,2]]},{name:"PHP, Wordpress",years:[[16,5],[17,4],[18,4]]},{name:"AWS Lambda, EC2, S3...",years:[[20,4],[21,4],[22,5],[23,6],[24,6]]},{name:"Docker / Podman",years:[[22,3],[23,6],[24,5]]},{name:"Rust",years:[[21,2],[23,4],[24,5]]},{name:"Google Cloud / Firebase",years:[[21,3],[22,4]]},{name:"DynamoDB",years:[[21,2],[22,2],[22,3],[24,4]]},{name:"Infra & CI/CD Tools",years:[[22,3],[23,3],[24,3]]},{name:"AWS Athena, Glue, ETLs",years:[[22,2],[23,3],[24,2]]}],B=[{company:"Hortifrut SA",years:[202211,-1],description:["Desarrollo de software empresarial para áreas de producción, sanidad y mejora contínua con React.js, Go, Node.js, PostgreSQL y DynamoDB","Desarrollo sobre servicios AWS como Lambda, S3, ECS, CloudFront, Athena, API-Gateway mediante SDK y CLI","Coordinación con múltiples áreas para el levantamiento técnico-funcional de los proyectos de software"],role:"Full Stack Developer",logo:m,pdfCardHeight:1.1},{company:"Yawi Solutions",role:"Senior Software Developer",years:[202003,202211],logo:h,pdfCardHeight:1.1,description:["Desarrollo de software empresarial con Angular, React.js + Vite.js, C# / .NET Core, Node.js y Go.","Modelado de base de datos Sql-Server y PostgreSQL","Manejo de librerías gráficas (web), estadísticas y geo-espaciales","Diseño de arquitectura cloud en AWS con CloudFormation y en Azure.","Lider técnico del equipo de Software Factory y rol como Scrum Master"]},{company:"Upwork",years:[201906,202003],logo:f,pdfCardHeight:.9,description:["Desarrollo de sistemas web con React, Node y MongoDB: Catálogo de cursos para institución educativa","Desarrollo de gestor de contenidos para páginas web con JavaScript","Desarrollo de sistema de búsqueda de empleo y scraping con React, Node.js y PostgreSQL"],role:"Freelance Software Developer"},{company:"Unicore",logo:g,years:[201804,201906],role:"Software Developer & Founder",pdfCardHeight:.95,description:["Desarrollo de sistema empresarial con módulos de ventas, finanzas, logística, productos y facturación electrónica usando PostgreSQL, DynamoDB, Node.js, React.js y WebSockets","Desarrollo de páginas webs con CMS e integración con plataformas de pago.","Uso de AWS Lambda, S3, EC2 y Linux VPCs y Bash"]},{company:"Permex International",logoImg:"images/permex4.webp",years:[201604,201802],role:"Jefe de Operaciones",pdfCardHeight:.9,description:["Planificación y control de la producción y el abastecimiento para la producción de chips de carnaza","Gestión de la logística internacional y trámites para la exportación de contenedores a USA","Elaboración de presupuestos, reportes de gastos y gestión financiera."]},{company:"EQUOM SAC",years:[201501,201603],logo:w,pdfCardHeight:.8,description:["Participación en desarrollo de CompuBox: Mini-PC Linux con procesador ARM","Coordinación con proveedores internacionales, gestión del proceso de importación y manejo financiero"],role:"Jefe de Operaciones"}],q=[{es:"Genix: Sistema de gestión para Mypes (Logística, Comercial, Finanzas)"},{es:"Librería de conversación de imagen .webp y .avif en Go con binarios precompilados hechos en Rust"},{es:"ORM para ScyllaDB / Cassandra hecho en Go"},{es:"SmartBerry. Sistema de gestión de producción agrícola de Hortifrut"},{es:"Jobfinder. Sistema de búsqueda de empleos y scraping"},{es:"Páginas web y CSM con React + Next.js"}],P=[{name:"FORTALEZAS",list:["Balance entre habilidades técnicas y blandas","Experiencia en varios lenguajes y framework permite adoptar nuevas herramientas rápido","Experiencia en arquitectura cloud / AWS","Background en negocios, finanzas y operaciones en empresas industriales","Experiencia desarrollando sobre bases de código grandes con equipos multidiciplinarios"]},{name:"DEBILIDADES",list:["Poca experiencia en kubernetes, MS-Windows y apps móviles","Poca experiencia en Python, AI y ciencia de datos","Tendencia de asumir el riesgo de incorporar nuevas tecnologías"]},{name:"OPORTUNIDADES",list:["Tecnologías actuales"]},{name:"AMENAZAS",list:["TBD"]}],R=[{name:"Platzi",carrer:"Desarrollo de Software",logo:z,years:"2019-2022",content:[`Cursos: JavaScript, TypeScript, ReactJS, Golang, Frontend Development,
    Back-end con NodeJs y ExpressJs. SCRUM. Arquitectura cloud con AWS.`]},{name:"Uni. Privada Antenor Orrego",carrer:"Maestría en Administración con Mención en Finanzas",logo:S,years:"2018-2019",content:[]},{name:"Uni. Privada del Norte",carrer:"Carrera de Administración y negocios internacionales",logo:D,years:"2009-2014",content:["Licenciado","Rendimiento: 5to Superior","Tesis: Reducción del precio CIF mediante el apalancamiento operativo-financiero."]}],j=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 20"><path d="m24.85 18 1.5 1.66A3 3 0 0 1 25 20H3a3 3 0 0 1-1.35-.34L3.14 18l6.47-7.19L12 13.17a2.8 2.8 0 0 0 4 0l2.41-2.36zm-11.43-6.26a.8.8 0 0 0 1.16 0L24.53 2 26.27.29A3 3 0 0 0 25 0H3a3 3 0 0 0-1.27.29L3.47 2ZM8.18 9.41 2 3.36.31 1.7A3 3 0 0 0 0 3v14a3 3 0 0 0 .26 1.21L2 16.28ZM27.69 1.7 26 3.36l-6.18 6.05L26 16.28l1.74 1.93A3 3 0 0 0 28 17V3a3 3 0 0 0-.31-1.3" fill="#ffcc6f" data-name="Layer 2"/></svg>
`,E=`<svg xml:space="preserve" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 41.4 64.2"><path d="M39.3 29.7c1.3-2.7 2.1-5.8 2.1-9C41.4 9.3 32.1 0 20.7 0S0 9.3 0 20.7c0 3.2.8 6.3 2.1 9 0 0 .4.9.5 1l18.1 33.5 17.9-33c.2-.4.7-1.5.7-1.5M20.7 10.4C26.4 10.4 31 15 31 20.7s-4.6 10.4-10.3 10.4-10.3-4.6-10.3-10.3S15 10.4 20.7 10.4" fill="#fea"/></svg>
`;export{R as a,L as b,j as c,H as d,O as e,P as f,p as g,V as h,E as i,I as j,M as k,U as m,C as p,A as r,T as s,F as t,q as u,B as w};
