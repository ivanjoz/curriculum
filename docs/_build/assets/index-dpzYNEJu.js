import{n as g,B as H,t as i,h as W,d as b,m as l0,F as a,G as T,w as r0,x as k}from"./web-CsdZQrJ0.js";const d0=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
...
<svg
   ...
   xmlns:svg="http://www.w3.org/2000/svg"><defs
     ...
     transform="translate(-5.4,-13.6)"><path
       ...
       id="path6" /></g></svg>
`,w0=`<?xml version="1.0" encoding="UTF-8"?>
...
`,z0='<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><title>linkedin-flat</title><g id="Linkedin"><circle id="back" cx="256" cy="256" r="256" fill="#0076b2"/><g id="Linkedin-2" data-name="Linkedin"><path d="M116.3,207h59.47V398.16H116.3Zm29.75-95a34.45,34.45,0,1,1-34.47,34.45A34.46,34.46,0,0,1,146.05,112" fill="#fff"/><path d="M213,207h57v26.14h.82c7.92-15,27.31-30.88,56.21-30.88,60.16,0,71.27,39.59,71.27,91.07V398.16H338.9v-93c0-22.17-.38-50.69-30.87-50.69-30.91,0-35.63,24.16-35.63,49.1v94.55H213Z" fill="#fff"/></g></g></svg>',b0=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
   width="1024"
   height="1024"
...
`,D0=[{percent:72,content:{es:"Desarrollo (código)",en:"Desarrollo (código)"}},{percent:16,content:{es:"Levantamiento de definiciones funcionales, investigación, documentación y arquitectura",en:"Levantamiento de definiciones funcionales, investigación, documentación y arquitectura"}},{percent:12,content:{es:"Reuniones de coordinación, daylis y mentoría",en:"Reuniones de coordinación, daylis y mentoría"}}],C0=[{icon:b0,url:"https://github.com/ivanjoz/"},{icon:z0,url:"https://www.linkedin.com/in/anguloivan/"},{icon:S0,url:"https://medium.com/@angivan"}],G0=[{desc:"Experiencia como Scrum Master en proyectos Agile",icon:y0},{desc:"Inglés avanzado y español nativo",icon:x0},{desc:"Experiencia en arquitectura cloud, AWS y DevOps",icon:v0},{desc:"Habilidades comunicativas y de coordinación",icon:f0},{desc:"Desarrollo enfocado en escabilidad y mantenibilidad en sistemas complejos",icon:w0}],$0=[{es:"Git, Python, Kotlin y Flutter + Dart",en:""},{es:"AWS: Cloudformation, IAM, API-Gateway, CloudFront",en:""},{es:"Vite.js, Next.js, Service Workers, PWA, WebSockets",en:""},{es:"Cálculos geo-espaciales y renderización de mapas",en:""}],V0=[{name:"Go Programming",years:[[22,6],[23,8],[24,8]]},{name:"C# & .NET Core",years:[[20,6],[21,4],[22,3]]},{name:"Solid.js",years:[[22,3],[23,4],[23,6]]},{name:"ScyllaDB / Cassandra",years:[[23,3],[24,4]]},{name:"Node.js",years:[[19,8],[20,8],[21,6],[22,5],[23,4]]},{name:"React.js",years:[[19,3],[20,5],[21,6],[22,8],[23,6],[23,4]]},{name:"Angular",years:[[20,8],[21,4]]},{name:"PostgreSQL",years:[[20,4],[21,5],[22,8],[23,7]]},{name:"SQL Server",years:[[17,4],[20,8],[21,4]]},{name:"Mongo DB / ArangoDB",years:[[18,7],[19,7]]},{name:"JavaScript & WebAPIs",years:[[17,8],[18,7],[19,7],[20,7],[21,6],[22,6],[23,6],[24,6]]},{name:"Linux / Bash / Nginx / VPS",years:[[16,3],[17,3],[18,2],[19,1],[20,3],[21,2],[22,2],[23,2],[24,2]]},{name:"PHP / Wordpress",years:[[16,5],[17,4],[18,4]]},{name:"AWS Lambda, EC2, ECS, S3",years:[[20,4],[21,4],[22,5],[23,6],[24,6]]},{name:"Docker / Podman",years:[[22,3],[23,6],[24,5]]},{name:"Rust",years:[[21,2],[23,4],[24,5]]},{name:"Google Cloud / Firebase",years:[[21,3],[22,4]]},{name:"DynamoDB",years:[[21,2],[22,2],[22,3],[24,4]]},{name:"Infra & CI/CD Tools",years:[[22,3],[23,3],[24,3]]},{name:"AWS Athena / Glue / ETLs",years:[[22,2],[23,3],[24,2]]}],A0=[{company:"Hortifrut SA",description:["Desarrollo de software empresarial para áreas de producción, sanidad y mejora contínua con React.js, Go, Node.js, PostgreSQL y DynamoDB","Desarrollo sobre servicios AWS como Lambda, S3, ECS, CloudFront, Athena, API-Gateway mediante SDK y CLI","Coordinación con múltiples áreas para el levantamiento técnico-funcional de los proyectos de software"],role:"Full Stack Developer",logo:d0},{company:"Yawi Solutions",role:"Senior Software Developer",logo:p0,description:["Desarrollo de software empresarial con Angular, React.js + Vite.js, C# / .NET Core, Node.js y Go.","Modelado de base de datos Sql-Server y PostgreSQL","Manejo de librerías gráficas (web), estadísticas y geo-espaciales","Diseño de arquitectura cloud en AWS con CloudFormation y en Azure.","Lider técnico del equipo de Software Factory y rol como Scrum Master"]},{company:"Upwork",logo:m0,description:["Desarrollo de sistemas web con React, Node y MongoDB: Catálogo de cursos para institución educativa","Desarrollo de gestor de contenidos para páginas web con JavaScript","Desarrollo de sistema de búsqueda de empleo y scraping con React, Node.js y PostgreSQL"],role:"Freelance Software Developer"},{company:"Unicore",logo:h0,role:"Software Developer & Founder",description:["Desarrollo de sistema empresarial con módulos de ventas, finanzas, logística, productos y facturación electrónica usando PostgreSQL, DynamoDB, Node.js, React.js y WebSockets","Desarrollo de páginas webs con CMS e integración con plataformas de pago.","Uso de AWS Lambda, S3, EC2 y Linux VPCs y Bash"]},{company:"Permex International",logoImg:"images/permex4.webp",role:"Jefe de Operaciones",description:["Planificación y control de la producción y el abastecimiento para la producción de chips de carnaza","Gestión de la logística internacional y trámites para la exportación de contenedores a USA","Elaboración de presupuestos, reportes de gastos y gestión financiera."]},{company:"EQUOM SAC",logo:g0,description:["Participación en desarrollo de CompuBox: Mini-PC Linux con procesador ARM","Coordinación con proveedores internacionales, gestión del proceso de importación y manejo financiero"],role:"Jefe de Operaciones"}],U0=[{name:"FORTALEZAS",list:["Balance entre habilidades técnicas y blandas","Experiencia en varios lenguajes y framework permite adoptar nuevas herramientas rápido","Experiencia en arquitectura cloud / AWS","Background en negocios, finanzas y operaciones en empresas industriales","Experiencia desarrollando sobre bases de código grandes con equipos multidiciplinarios"]},{name:"DEBILIDADES",list:["Poca experiencia en kubernetes, MS-Windows y apps móviles","Poca experiencia en Python, AI y ciencia de datos","Tendencia de asumir el riesgo de incorporar nuevas tecnologías"]},{name:"OPORTUNIDADES",list:["Tecnologías actuales"]},{name:"AMENAZAS",list:["TBD"]}],I0=[{name:"Platzi",logo:k0,content:[]},{name:"Uni. Privada Antenor Orrego",logo:u0,content:[]},{name:"Uni. Privada del Norte",logo:_0,content:[]}],P0="_",L0="a",M0="b",H0="c",T0="d",F0="e",q0="f",B0="g",E0="h",O0="i",R0="j",j0="k",W0="l",Z0="m",N0="n",Q0="o",J0="p",K0="q",Y0="r",X0="s",n1="t",e1="u",t1="v",a1="w",i1="x",s1="y",c1="z",e={main:P0,content:L0,about_me_layer:M0,about_me_layer_inline:H0,photo_circle:T0,letter:F0,location:q0,location_container:B0,table_header:E0,table_cell:O0,cell_line:R0,table_main_container:j0,table_main:W0,table_cell_1:Z0,table_card:N0,table_card_container:Q0,table_card_image_ctn:J0,table_card_image:K0,foda_card:Y0,skill_card:X0,skill_image:n1,skill_descrip:e1,skill_card_container:t1,social_icon:a1,about_me:i1,email_icon:s1,tecnologias_container:c1},o1=`<?xml version="1.0" encoding="UTF-8"?>
...
`,F=c=>`data:image/svg+xml;charset=utf-8,${encodeURIComponent(c)}`;var n0=k("<div>"),r1=k("<div><div>"),d1=k('<div><!$><!/><!$><!/><div><h2 class=bold>Tecnologías / Años de Experiencia</h2><div><div><table><thead><tr></tr></thead><tbody></tbody></table></div><div><div class="bold h3 tt-c1">Experiencia adicional en:</div><!$><!/><div></div><div class="bold h3 tt-c1">Día de trabajo habitual:</div><table><tbody></tbody></table></div></div><h2>Skills</h2><div></div><h2 class=bold>Experiencia Laboral</h2><div></div><h2 class=bold>Últimos Proyectos</h2><div><div>● Genix: Sistema de gestión para Mypes (Logística, Comercial, Finanzas)</div><div>● Librería de conversación de imagen .webp y .avif en Go con binarios precompilados hechos en Rust.</div><div>● ORM para ScyllaDB / Cassandra hecho en Go.</div><div>● SmartBerry. Sistema de gestión de producción agrícola de Hortifrut.</div><div>● Sistema de componentes frontend en Solid.Js</div><div>● Jobfinder. Sistema de búsqueda de empleos y scraping.</div><div>● Páginas web y CSM con React + Next.js</div></div><h2 class=bold>F.O.D.A</h2><div></div><h2 class=bold>Estudios</h2><div>'),p1=k("<th><div>"),m1=k("<tr>"),h1=k("<td>"),g1=k("<div class=flex><div>●</div><div>"),f1=k('<tr><td class="bold h3"></td><td class="">'),v1=k('<div><img alt=""><div>'),w1=k('<div><div class="bold h5 tt-c1 w100 ta-c"></div><!$><!/>'),e0=k("<div>● <!$><!/>"),y1=k('<div><div><div><img src=images/ivan-angulo-profile.webp alt="ivan angulo reyna profile"></div><div><h1 class="h1 bold">Iván J. Angulo Reyna</h1></div><div><img alt=""><div>Trujillo - Perú</div></div></div><div><div><h2 class="h2 bold">Software Developer FullStack</h2></div><div>5+ años de experiencia desarrollando sistemas cloud con Node.Js, Go y C# y AWS, Linux, frontend con React y bases de datos SQL.</div><div class=flex></div><div><img alt=""><div>ivan@un.pe'),x1=k('<div><img alt="">'),t0=k('<div><div><div><img alt=""></div><div><div class="h2 bold tt-c1"></div><div></div></div></div><div>');const k1=17,u1=24,J=c=>typeof c=="string"?c:c.es||c.en;function S1(){const c=[{name:"",setContent:o=>(()=>{var d=g(n0);return i(d,()=>o.name),b(()=>a(d,e.table_cell_1)),d})()}];for(let o=k1;o<=u1;o++)c.push({name:`${o}`,headerCss:e.table_header,cellCss:e.table_cell,setContent:d=>{const f=d.years.find(w=>w[0]===o);if(!f)return null;let p=0;return p=(f[1]-1)*2,p<3&&(p=3),p>18&&(p=18),(()=>{var w=g(r1),m=w.firstChild;return w.style.setProperty("height","100%"),w.style.setProperty("position","relative"),`${p}px`!=null?m.style.setProperty("height",`${p}px`):m.style.removeProperty("height"),b(()=>a(m,e.cell_line)),w})()}});return(()=>{var o=g(d1),d=o.firstChild,[f,p]=H(d.nextSibling),w=f.nextSibling,[m,V]=H(w.nextSibling),$=m.nextSibling,s=$.firstChild,h=s.nextSibling,v=h.firstChild,u=v.firstChild,_=u.firstChild,D=_.firstChild,Z=_.nextSibling,t=v.nextSibling,C=t.firstChild,L=C.nextSibling,[z,A]=H(L.nextSibling),S=z.nextSibling,q=S.nextSibling,B=q.nextSibling,E=B.firstChild,O=h.nextSibling,M=O.nextSibling,R=M.nextSibling,N=R.nextSibling,a0=N.nextSibling,K=a0.nextSibling,i0=K.nextSibling,Q=i0.nextSibling,s0=Q.nextSibling,Y=s0.nextSibling;return i(o,W(X,{get css(){return e.about_me_layer}}),f,p),i(o,W(X,{get css(){return e.about_me_layer_inline}}),m,V),i(D,()=>c.map(n=>(()=>{var l=g(p1),r=l.firstChild;return i(r,()=>n.name),b(()=>a(r,n.headerCss)),l})())),i(Z,()=>V0.map(n=>(()=>{var l=g(m1);return i(l,()=>c.map(r=>(()=>{var y=g(h1);return i(y,()=>r.setContent(n)),b(()=>a(y,r.cellCss)),y})())),l})())),t.style.setProperty("flex-grow","1"),t.style.setProperty("margin-left","1vw"),t.style.setProperty("display","flex"),t.style.setProperty("flex-direction","column"),i(t,()=>$0.map(n=>(()=>{var l=g(g1),r=l.firstChild,y=r.nextSibling;return r.style.setProperty("width","0.8rem"),i(y,()=>J(n)),l})()),z,A),S.style.setProperty("width","100%"),S.style.setProperty("border-bottom","1px solid black"),S.style.setProperty("margin","12px 0"),i(E,()=>D0.map(n=>(()=>{var l=g(f1),r=l.firstChild,y=r.nextSibling;return i(r,()=>`${n.percent}%`),i(y,()=>J(n.content)),l})())),i(M,()=>G0.map(n=>(()=>{var l=g(v1),r=l.firstChild,y=r.nextSibling;return i(y,()=>J(n.desc)),b(x=>{var U=`${e.skill_card}`,I=`${e.skill_image}`,G=F(n.icon),P=`${e.skill_descrip}`;return U!==x.e&&a(l,x.e=U),I!==x.t&&a(r,x.t=I),G!==x.a&&T(r,"src",x.a=G),P!==x.o&&a(y,x.o=P),x},{e:void 0,t:void 0,a:void 0,o:void 0}),l})())),i(N,()=>A0.map(n=>W(_1,{args:n}))),K.style.setProperty("padding-left","0.8rem"),i(Q,()=>U0.map(n=>(()=>{var l=g(w1),r=l.firstChild,y=r.nextSibling,[x,U]=H(y.nextSibling);return i(r,()=>n.name),i(l,()=>n.list.map(I=>(()=>{var G=g(e0),P=G.firstChild,j=P.nextSibling,[c0,o0]=H(j.nextSibling);return i(G,I,c0,o0),G})()),x,U),b(()=>a(l,e.foda_card)),l})())),i(Y,()=>I0.map(n=>W(z1,{args:n}))),b(n=>{var l=e.main,r=e.content,y=`flex w100 ${e.tecnologias_container}`,x=e.table_main_container,U=`w100 ${e.table_main}`,I=`flex ${e.skill_card_container}`,G=e.table_card_container,P=e.table_card_container,j=e.table_card_container;return l!==n.e&&a(o,n.e=l),r!==n.t&&a($,n.t=r),y!==n.a&&a(h,n.a=y),x!==n.o&&a(v,n.o=x),U!==n.i&&a(u,n.i=U),I!==n.n&&a(M,n.n=I),G!==n.s&&a(N,n.s=G),P!==n.h&&a(Q,n.h=P),j!==n.r&&a(Y,n.r=j),n},{e:void 0,t:void 0,a:void 0,o:void 0,i:void 0,n:void 0,s:void 0,h:void 0,r:void 0}),o})()}const X=c=>(()=>{var o=g(y1),d=o.firstChild,f=d.firstChild,p=f.nextSibling,w=p.nextSibling,m=w.firstChild,V=m.nextSibling,$=d.nextSibling,s=$.firstChild,h=s.firstChild,v=s.nextSibling,u=v.nextSibling,_=u.nextSibling,D=_.firstChild,Z=D.nextSibling;return m.style.setProperty("margin-right","3px"),m.style.setProperty("width","1rem"),m.style.setProperty("height","1rem"),h.style.setProperty("margin-bottom","0"),v.style.setProperty("padding","8px"),v.style.setProperty("text-align","center"),i(u,()=>C0.map(t=>(()=>{var C=g(x1),L=C.firstChild;return C.$$click=z=>{z.stopPropagation(),window.open(t.url)},b(z=>{var A=e.social_icon,S=F(t.icon);return A!==z.e&&a(C,z.e=A),S!==z.t&&T(L,"src",z.t=S),z},{e:void 0,t:void 0}),r0(),C})())),D.style.setProperty("margin-right","6px"),D.style.setProperty("width","1rem"),D.style.setProperty("height","1rem"),b(t=>{var C=c.css,L=e.photo_circle,z=`${e.letter}`,A=`flex ${e.location_container}`,S=F(o1),q=`h3 ${e.location}`,B=e.letter,E=`${e.letter} ${e.about_me}`,O=`flex ${e.email_icon}`,M=F(l1),R=`h3 ${e.location}`;return C!==t.e&&a(o,t.e=C),L!==t.t&&a(f,t.t=L),z!==t.a&&a(p,t.a=z),A!==t.o&&a(w,t.o=A),S!==t.i&&T(m,"src",t.i=S),q!==t.n&&a(V,t.n=q),B!==t.s&&a(s,t.s=B),E!==t.h&&a(v,t.h=E),O!==t.r&&a(_,t.r=O),M!==t.d&&T(D,"src",t.d=M),R!==t.l&&a(Z,t.l=R),t},{e:void 0,t:void 0,a:void 0,o:void 0,i:void 0,n:void 0,s:void 0,h:void 0,r:void 0,d:void 0,l:void 0}),o})(),_1=c=>(console.log("logo:: ",c.args.logo),(()=>{var o=g(t0),d=o.firstChild,f=d.firstChild,p=f.firstChild,w=f.nextSibling,m=w.firstChild,V=m.nextSibling,$=d.nextSibling;return d.style.setProperty("display","flex"),i(m,()=>c.args.company),i(V,()=>c.args.role),i($,()=>c.args.description.map(s=>(()=>{var h=g(e0),v=h.firstChild,u=v.nextSibling,[_,D]=H(u.nextSibling);return i(h,s,_,D),h})())),b(s=>{var h=e.table_card,v=e.table_card_image_ctn,u=e.table_card_image,_=c.args.logoImg||F(c.args.logo);return h!==s.e&&a(o,s.e=h),v!==s.t&&a(f,s.t=v),u!==s.a&&a(p,s.a=u),_!==s.o&&T(p,"src",s.o=_),s},{e:void 0,t:void 0,a:void 0,o:void 0}),o})()),z1=c=>(console.log("logo:: ",c.args.logo),(()=>{var o=g(t0),d=o.firstChild,f=d.firstChild,p=f.firstChild,w=f.nextSibling,m=w.firstChild,V=m.nextSibling,$=d.nextSibling;return d.style.setProperty("display","flex"),i(m,()=>c.args.name),i(V,()=>c.args.content),i($,()=>c.args.content.map(s=>(()=>{var h=g(n0);return i(h,s),h})())),b(s=>{var h=e.table_card,v=e.table_card_image_ctn,u=e.table_card_image,_=F(c.args.logo);return h!==s.e&&a(o,s.e=h),v!==s.t&&a(f,s.t=v),u!==s.a&&a(p,s.a=u),_!==s.o&&T(p,"src",s.o=_),s},{e:void 0,t:void 0,a:void 0,o:void 0}),o})());l0(["click"]);export{S1 as default};
